---
title: "Forlux ekologiczny żel do | Postaw na sprawdzoną jakość!"
url: https://eazbiuro.pl/pl/product/69867,forlux-ekologiczny-zel-do-sanitariatow-eco-sg501-5l
lastmod: 
type: product
---
Forlux ekologiczny żel do | Postaw na sprawdzoną jakość!
...
Forlux ekologiczny żel do sanitariatów eco sg501 5l
...
Forlux ekologiczny żel do sanitariatów eco sg501 dostępny w eazbiuro.pl! | Dodaj do koszyka ekspresowo
...
- Preparat Eco SG 501 Żel do sanitariatów służy do mycia ceramicznych i metalowych muszli klozetowych, umywalek, wanien, brodzików, bidetów, glazury i terakoty.
- Samoczynnie i skutecznie usuwa zabrudzenia i kamień, nadaje połysk i pozostawia przyjemny długotrwały zapach.
- Żel jest dostępny w opakowaniach 0,75 litra typu „kaczka”, co pozwala na równomiernie i oszczędne nanoszenie, jednocześnie ułatwiając dotarcie do trudno dostępnych .
- Do produkcji preparatu ECO SG 501, użyto składników które posiadają ECO CERTYFIKATY
- z tego powodu ECO SG 501 jest produktem ekologicznie bezpiecznym dla środowiska  oraz użytkownika.
- Sposób użycia: mycie glazury: preparat nanieść na ściereczkę lub gąbkę, przetrzeć mytą powierzchnię i ewentualnie wytrzeć do sucha, aby usunąć ślady kropli. Mycie umywalek i armatury: preparat nanieść na gąbkę lub ściereczkę, przetrzeć nią mytą powierzchnię, następnie spłukać wodą i wytrzeć do sucha.
- Ze względu na zawartość w płynie kwasku cytrynowego unikać kontaktu z oczami. 
