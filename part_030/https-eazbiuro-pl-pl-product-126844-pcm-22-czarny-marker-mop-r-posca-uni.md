---
title: "Pcm-22 czarny marker mop'r posca | Wybierz tanio i wygodnie!"
url: https://eazbiuro.pl/pl/product/126844,pcm-22-czarny-marker-mop-r-posca-uni
lastmod: 
type: product
---
Pcm-22 czarny marker mop'r posca | Wybierz tanio i wygodnie!
...
Pcm-22 czarny marker posca uni dostępny w eazbiuro.pl! | Skorzystaj w promocyjnej cenie
...
- Markery POSCA PCM-22 będą doskonałe do street-artu oraz fine-artu
- Skierowane są przede wszystkim do: artystów, graficiarzy, studentów, uczniów oraz dzieci w każdym wieku
- Dzięki ergonomicznemu kształtowi i ciekawej konstrukcji POSCA MOP'R zapewniają wygodny i stabilny chwyt oraz całkowicie nowe doświadczenia artystyczne
- Możesz tworzyć nimi duże rysunki w poziomie lub w pionie
- Markery posiadają innowacyjny system zaworów, który zapewnia doskonały przepływ tuszu i kontrolę oraz możliwość tworzenia kropli, gdy trzymasz pisak do góry nogami
- MOP'R może być używany do wielu technik, które są trudniejsze do osiągnięcia przy użyciu tradycyjnych końcówek
- Twórz abstrakcyjne plamy, rozpryski, stemple, efekty podobne do farb w sprayu, podkreślenia i wiele innych
- Dzięki markerom POSCA można samodzielnie zaprojektować koszulkę czy czapkę z daszkiem - wystarczy zaprasować materiał i wymyślony wzór będzie trwały
- Produkt wykorzystywany może być także do ozdoby szyb sklepowych, sprzętu muzycznego, sportowego czy nawet auta
- Markery POSCA MOP'R są permanentne, doskonałe do stosowania na wielu powierzchniach
- Zawierają tusz pigmentowy na bazie wody, który jest odporny na światło
- Markery są trwałe na chłonnych mediach, takich jak papier i drewno, mogą być usunięte z błyszczących powierzchni za pomocą skrobaka
- Rodzaj końcówki: piankowo-gumowa
- Grubość linii pisania: 3-19 mm
- Kolor: czarny 
