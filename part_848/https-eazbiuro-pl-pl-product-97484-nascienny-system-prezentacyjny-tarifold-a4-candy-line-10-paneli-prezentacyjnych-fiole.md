...
url: https://eazbiuro.pl/pl/product/97484,nascienny-system-prezentacyjny-tarifold-a4-candy-line-10-paneli-prezentacyjnych-fiolet-transp
lastmod: 
type: product
---
...
Naścienny system prezentacyjny tarifold A4 candy line +10 paneli prezentacyjnych fiolet transp.
...
Naścienny system prezentacyjny tarifold A4 candy dostępny w eazbiuro.pl! | Zgarnij już teraz

Opis produktu
Naścienny system prezentacyjny Tarifold z serii Candy Line w rozmiarze A4 przeznaczony do montowania na pionowych powierzchniach. Kolekcja ta wyróżnia się ramkami i ogranicznikami w żywych, półprzezroczystych kolorach przyciągających wzrok. W skład zestawu wchodzi jeden wysokiej jakości metalowy uchwyt naścienny i 10 paneli prezentacyjnych otwieranych z góry w kolorze fioletowym transparentnym. System pozwala w łatwy sposób zapewnić szybki dostęp do wszystkich ważnych informacji w miejscach, gdzie są potrzebne. Posiada 4 ograniczniki, dzięki którym panele układają się wachlarzowo. Dzięki nieograniczonej możliwości rozbudowy poprzez proste łączenie elementów obok siebie, stanowi idealny nośnik nawet dla dużej ilości informacji. Model zawiera komplet paneli prezentacyjnych, wykonanych według opatentowanej francuskiej technologii, zapewniając niezrównany poziom jakości i wytrzymałości. Specjalny stalowy drut powoduje, że panele są bardzo elastyczne i zarazem odporne na wszelkiego rodzaju zgięcia. Kolorowa ramka ułatwia identyfikację i prezentację dokumentów. Matowy, antyodblaskowy materiał z przyjaznego dla środowiska PVC 110 µ eliminuje refleksy świetlne, ułatwiając czytanie nawet przy bezpośrednio padającym świetle. Dostarczane wraz z 5 zakładkami indeksującymi umożliwiającymi organizację prezentowanych treści. Wszystkie produkty marki Tarifold są wykonane z materiałów najwyższej europejskiej jakości pozwalającej użytkownikowi na korzystanie z produktu bez żadnych awarii, o czym dodatkowo świadczy gwarancja producenta, która wynosi aż 10 lat. 
