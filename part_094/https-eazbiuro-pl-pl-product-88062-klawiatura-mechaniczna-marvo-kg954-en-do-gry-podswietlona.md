---
title: "Klawiatura mecHaniczna Marvo | Kup szybko i bezpiecznie!"
url: https://eazbiuro.pl/pl/product/88062,klawiatura-mechaniczna-marvo-kg954-en-do-gry-podswietlona
lastmod: 
type: product
---
Klawiatura mecHaniczna Marvo | Kup szybko i bezpiecznie!
...
Klawiatura mecHaniczna Marvo kg954 en, do gry, podświetlona
...
Marvo kg954 en, klawiatura us, do gry, mecHanicz dostępny w eazbiuro.pl! | Odbierz od ręki
...
- Klawiatura dla gracza Marvo — KG954 
- KG954 to pełnowymiarowa mechaniczna klawiatura o konstrukcji bez-ramkowej aby ograniczyć do minimum przestrzeń, którą zajmuje urządzenie na biurku
- Specjalne klawisze multimedialne i przycisk regulacji głośności
- Zaawansowana klawiatura z funkcją anti-ghosting, tęczowe podświetlenie z 21 efektami kolorystycznymi to tylko nieliczne z atutów klawiatury Marvo
- Wysoki standard projektowania i trwałość konstrukcji i nowoczesny design tworzą z KG954 klawiaturę, która przykuwa wzrok na pierwszy rzut oka i pasuje do każdego otoczenia
- Podświetlane, niebieskie przełączniki mechaniczne mogą wytrzymać dziesiątki milionów naciśnięć, dzięki czemu będziesz miłym towarzyszem na długie lata
- Podwójne nakładki na klawisze z warstwą zapobiegającą odciskom palców również wydłużają żywotność klawiatury 
- Klawiatura jest również odporna na zalanie
- W przypadku nagłego rozlania płyn szybko spływa z klawiatury
- Klawiatura KG954 EN oprócz podświetlenia klawiszy oferuje także niezwykle efektowne czerwone podświetlenie krawędzi z lewej i prawej strony klawiatury
- LED ukryte są w spodniej części klawiatury uzyskując poświatę, która nie razie w trakcie gry
- Ta klawiatura do gier oferuje zaawansowany system anti-ghosting, który gwarantuje bezproblemowe granie w każdą grę na PC, w której używasz dużej liczby przycisków naraz
- Zaawansowani użytkownicy mogą cieszyć się szeregiem innych funkcji, takich jak funkcje sterowania podświetleniem, klawisze kombinacji makro, funkcje multimedialne i biurowe, które dostępne są z poziomu dedykowanego oprogramowania
- Gracz może dostosować aż 102 programowalne przyciski do swoich preferencji
- Dane techniczne: 
- Liczba przycisków: 107 (102 programowalne)
- Typ przełącznika: mechaniczny 
- Żywotność przełącznika: 50 milionów naciśnięć 
- Skok klawiszy: 3,8 ± 0,3 mm
- Podświetlenie: mix kolorów (rainbow) 
- Połączenie: USB 2.0, 
- Długość kabla: 1,6 m 
- Kompatybilny z: Windows 7 i nowszymi
