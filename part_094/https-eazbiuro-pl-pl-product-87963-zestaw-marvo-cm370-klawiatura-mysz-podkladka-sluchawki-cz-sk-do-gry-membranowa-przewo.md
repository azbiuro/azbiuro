---
title: "Zestaw Marvo cm370, | Zamów dziś – odbierz szybko!"
url: https://eazbiuro.pl/pl/product/87963,zestaw-marvo-cm370-klawiatura-mysz-podkladka-sluchawki-cz-sk-do-gry-membranowa-przewodowa-usb-czarna
lastmod: 
type: product
---
Zestaw Marvo cm370, | Zamów dziś – odbierz szybko!
...
Zestaw Marvo cm370, klawiatura+mysz+podkładka+słuchawki, cz/sk, do gry, membranowa, przewodowa (usb), czarna
...
Zestaw Marvo cm370, klawiatura+mysz+podkładka+sł dostępny w eazbiuro.pl! | Wybierz w świetnej ofercie
...
- Marvo CM370 to zestaw przygotowany z myślą o graczach, składający się z myszy, podkładki, klawiatury oraz słuchawek
- W zestawie Marvo CM370, gracz otrzymuje funkcjonalną i trwałą klawiaturę membranową, z efektownym wielokolorowym podświetleniem LED (zarówno liter jak i całych klawiszy)
...
- Klawiatura podłączana jest do komputera za pomocą przewodu USB o długości 1,4 m
- Mysz Marvo została wyposażona w precyzyjny sensor optyczny o maksymalnej rozdzielczości 3200 DPI
- Ponadto poziom DPI można zmieniać pomiędzy czterema poziomami w czasie gry za pomocą przycisku DPI Switch
- Całość uzupełnia podświetlenie LED, które nadaje jej odpowiedniego charakteru oraz sprawia, że idealnie komponuje się z klawiaturą
- Kolejnym elementem zestawu Marvo CM-370 są słuchawki z jakością dźwięku stereo
- Słuchawki posiadają obustronną regulację długości,
dzięki czemu idealnie dopasowują się do kształtu głowy - Poduszki uszne zostały wyścielone miękkim, skóropodobnym materiałem dobrze izolującym dźwięki z otoczenia
- Doskonała jakość dźwięku wspaniale sprawdzi się w czasie grania, oglądania filmów czy słuchania muzyki
- Ostatnim elementem zestawu Marvo CM-370 jest podkładka wykonana z wysokiej jakości materiału, który zapewnia wysoką precyzję śledzenia ruchów myszy, oraz redukuje tarcie myszki o powierzchnię
...
- Liczba klawiszy: 104
- Siła: 70 ± 10 g
- Skok klawisza: 2,2 ± 0,5 mm
- Interfejs: USB 2.0
- Długość kabla: 1,4 m
- Podświetlenie: wielokolorowe (Rainbow)
- SPECYFIKACJA MYSZY:
- Czujnik: optyczny
- Rozdzielczość: 800/1600/2400/3200 DPI
- Liczba przycisków: 4
- Interfejs: USB 2.0
- Długość kabla: 1,5 m
