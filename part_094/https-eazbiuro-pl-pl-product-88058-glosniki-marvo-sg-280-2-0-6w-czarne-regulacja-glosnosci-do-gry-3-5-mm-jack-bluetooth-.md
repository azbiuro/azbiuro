---
title: "Głośniki Marvo sg-280, 2.0, | Zamów dziś – odbierz szybko!"
url: https://eazbiuro.pl/pl/product/88058,glosniki-marvo-sg-280-2-0-6w-czarne-regulacja-glosnosci-do-gry-3-5-mm-jack-bluetooth-soundbar-led
lastmod: 
type: product
---
Głośniki Marvo sg-280, 2.0, | Zamów dziś – odbierz szybko!
...
Głośniki Marvo sg-280, 2.0, 6w, czarne, regulacja głośności, do gry, 3,5 mm jack/ bluetooth, soundbar, led
...
Głośniki Marvo sg-280, 2.0, 6w, czarne, regulacj dostępny w eazbiuro.pl! | Dodaj do koszyka w super promocji
...
- Modularny soundbar Marvo SG-280
- Czym jest modularny soundbar? Soundbar Marvo to bardzo ciekawa konstrukcja 2 w 1, która umożliwia stosowanie głośnika w pozycji poziomej w formie soundbaru do umieszczenia np. pod monitorem lub dzięki możliwości rozłączenia swobodnego ustawienie 2 głośników Stereo
- Konstrukcja sondbaru Marvo prezentuje się niezwykle nowocześnie
- Futurystyczny wygląd z efektownym wielokolorowym podświetleniem z pewnością nadadzą Twojej przestrzeni nowego charakteru
- Na szczególną uwagę zasługuje tryb podświetlenia Spectrum, który reaguje na dźwięki gry lub muzyki co nadaje jej jeszcze lepszego efektu, szczególnie w trakcie nocnych rozgrywek
- Soundbar nie zależnie czy użytkowany w trybie poziomym czy osobnych głośników oferuje możliwość podłączenia dodatkowych urządzeń wyposażonych w komunikację bluetooth
- Dzięki czemu użytkownik może podłączyć do głośnika np telefon
- Marvo SG-280 wyposażony jest oczywiście w połączenie przewodowe jack 3.5 mm i może być podłączone na stałe do komputera stacjonarnego i prze bluetooth do laptopa gamingowego
- Za wybór źródła dźwięku decyduje ukryty obok pokręt potencjometru przycisk
- Soundbar oferuje użytkownikowi 6 trybów podświetlenia oraz możliwość jego wygaszenia
- 2 dwu calowe przetworniki dźwięku posiadają łączną moc 6W
- Specyfikacja:
- Moc: 6W
- Połączenie: Bluetooth + Jack 3.5 + USB (Zasilanie)
- Typ: Modularny 2 w 1
- Wymiary w pozycji poziomej:
- Szerokość: 38 cm
- Wysokość: 7,8 cm
- Głębokość: 6,8 cm
...
- Wysokość: 19  cm
- Głębokość: 6,8 cm 
- Długość przewodu: Jack 3.5 + USB: około 160 cm
- Długość przewodu łączącego głośniki: około 140 cm
- Regulacja głośności: TAK na głośniku
- Podświetlenie: TAK (6 trybów + Off)
- Połączenie bezprzewodowe: TAK Bluetooth (do 10 m)
