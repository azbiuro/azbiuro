---
title: "Klawiatura membranowa Marvo | Zrób wygodne zakupy online!"
url: https://eazbiuro.pl/pl/product/87975,klawiatura-membranowa-marvo-kg869-do-gry-podswietlona
lastmod: 
type: product
---
Klawiatura membranowa Marvo | Zrób wygodne zakupy online!
...
Klawiatura membranowa Marvo kg869, do gry, podświetlona
...
Klawiatura membranowa Marvo kg869, do gry, podśw dostępny w eazbiuro.pl! | Chwyć i odbierz dziś
...
- Klawiatura gamingowa Marvo KG869
- Podświetlana membranowa klawiatura multimedialna Marvo KG869 z regulacją głośności na specjalnym pokrętle zachwyci każdego gracza
- Dzięki podświetlanym klawiszom nadaje się również do gry w słabym oświetleniu
- Klawiatura zapewnia swoim użytkownikom funkcję antighosting- przytrzymania kilku klawiszy na raz, różnorodne ustawienia podświetlenia, w tym wybór niestandardowych obszarów podświetlenia oraz 
przesyłanie do 6 różnych klawiszy makr
- Zawiera również wbudowany uchwyt na nadgarstek
- Klawiatura oferuje ponad 10 zaprogramowanych schematów podświetlenia
- Oprócz ich przełączania możesz także używać skrótów klawiaturowych do regulacji jasności lub kierunku efektu podświetlenia
- Możesz także ustawić do 5 niestandardowych obszarów podświetlenia, czyli podświetl tylko te klawisze, które chcesz aby były podświetlone
- Jeśli potrzebujesz makr do swoich gier, istnieje możliwość zaprogramowania do 6 różnych klawiszy G1 - G6 bez użycia oprogramowania
- Polecenia, dla których zwykle trzeba nacisnąć kilka klawiszy, teraz można wykonać naciskając jeden klawisz
- Klawiaturta posiada 12 klawiszy multimedialnych ułatwiających obsługę odtwarzacza multimedialnego, kalkulatora, Internetu lub folderu
- Bardzo praktyczną rzeczą jest regulacja głośności na pokrętle, które znajduje się w prawym górnym rogu
- Liczba klawiszy: 121
- Rodzaj klawiatury: membranowa
- Żywotność klawiszy: 10 milionów kliknięć
- Antighosting: 26 klawiszy
- Klawisze makr
- Oprogramowanie
- Klawisze umożliwiające wejście do własnego obszaru podświetlenia
- Siła nacisku: 52 ± 7 g
- Podświetlenie: mieszanka 7 kolorów
- Łączność: USB 2.0
- Długość kabla: 1,5 m
