---
title: "Podstawka pod monitor Leitz | Odbierz z ekspresową dostawą!"
url: https://eazbiuro.pl/pl/product/127805,podstawka-pod-monitor-leitz-ergo-biala
lastmod: 
type: product
---
Podstawka pod monitor Leitz | Odbierz z ekspresową dostawą!
...
Podstawka pod monitor Leitz ergo biała
...
Podstawka pod monitor Leitz ergo biała dostępny w eazbiuro.pl! | Chwyć w świetnej cenie

Opis produktu
Podstawka pod monitor Leitz ma ergonomiczną konstrukcję, która zapewnia komfort w czasie pracy.
- podnosi ekran monitora, aby zapewnić komfortową dla oczu wysokość oraz skorygować postawę w czasie pracy
- wspiera efektywność, ułatwiając utrzymanie porządku na biurku dzięki dodatkowemu miejscu do przechowywania
- miejsce do przechowywania pod podstawką o wymiarach 479 x 210 x 84 mm (szer. x gł. x wys.) może zmieścić klawiaturę o szerokości do 470 mm
- miejsce do przechowywania może być również wykorzystane do przechowywania dokumentów, książek, notatników, smartfonów, długopisów i innych rzeczy
- odpowiednia dla monitorów o przekątnej ekranu do 24" i maksymalnej wadze do 20 kg
- łatwa do czyszczenia i odporna na zarysowania powierzchnia
- dostarczana w płaskim opakowaniu, montaż podstawki jest szybki i łatwy
- kolor: biały.
