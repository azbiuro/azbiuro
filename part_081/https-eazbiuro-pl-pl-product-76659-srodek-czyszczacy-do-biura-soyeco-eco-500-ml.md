---
title: "Środek czyszczący do biura soyeco, | Wybierz w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/76659,srodek-czyszczacy-do-biura-soyeco-eco-500-ml
lastmod: 
type: product
---
Środek czyszczący do biura soyeco, | Wybierz w A-Z Biuro!
...
Środek czyszczący do biura soyeco, eco, 500 ml dostępny w eazbiuro.pl! | Zamów w promocyjnej cenie
...
- Ekologiczny środek do czyszczenia biura
- Produkt dedykowany jest przede wszystkim do czyszczenia obudów sprzętów biurowych, takich jak: drukarki, skanery, myszki, klawiatury, komputery oraz monitory, równie dobrze sprawdza się w czyszczeniu blatów biurek, stolików czy parapetów. Produkt w wygodnej butelce ze spryskiwaczem, specjalnie przystosowany dla jak najbardziej komfortowego czyszczenia dużych powierzchni. Dzięki specjalnej, uniwersalnej formule środek można z powodzeniem zastosować także na wszelkich powierzchniach i urządzeniach RTV w domach, sklepach, zakładach produkcyjnych czy pracowniach komputerowych. Powstał specjalnie z myślą o Środowisku i ochronie Naszej Planety
- Pozbawiony jest: barwników, fosfonianów, parabenów, zagęstników, sztucznych związków zapachowych, SLSu , SLESu
- Zawiera substancje spełniające wymogi certyfikatu EU Ecolabel oraz naturalny olejek z pomarańczy, który nadaje delikatny, cytrusowy zapach.
- Butelki, w których oferujemy płyn, zostały wykonane z materiału HDPE „Biobased”, posiadający certyfikat „i’m green”. HDPE Biobased jest tworzywem, które zostało zrobione z trzciny cukrowej, a podczas jego produkcji z powietrza pochłaniany był dwutlenek węgla, tym samym zmniejszając emisję tego gazu do atmosfery, co przyczyniło się do zwalczania efektu cieplarnianego
- Etykieta produktu wykonana jest z papieru, który posiada certyfikat FSC, przyznany przez międzynarodową organizację, której celem jest działanie na rzecz zrównoważonego rozwoju lasów. 
- Ponadto, zarówno ten produkt jak i wszystkie pozostałe produkty z tej serii uzyskały certyfikat Viva Vegan przyznany przez fundację działającą na rzecz ochrony zwierząt. Certyfikat ten jest potwierdzeniem, że nasze środki nie posiadają żadnych produktów zwierzęcych ani odzwierzęcych oraz związków pozyskiwanych z oleju palmowego, a przy ich produkcji nie ucierpiało żadne zwierzę
- Opakowanie zawiera 500 ml płynu
