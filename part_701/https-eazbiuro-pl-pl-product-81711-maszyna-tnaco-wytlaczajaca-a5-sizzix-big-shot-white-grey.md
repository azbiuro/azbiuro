---
title: "Maszyna tnąco - wytłaczająca A5 - | Odbierz już jutro!"
url: https://eazbiuro.pl/pl/product/81711,maszyna-tnaco-wytlaczajaca-a5-sizzix-big-shot-white-grey
lastmod: 
type: product
---
Maszyna tnąco - wytłaczająca A5 - | Odbierz już jutro!
...
Maszyna tnąco - wytłaczająca A5 - sizzix big shot (white & grey)
...
Żdp-maszyna tnąco - wytłaczająca A5 - sizzix big s dostępny w eazbiuro.pl! | Złap w super promocji
...
- Maszyna tnąco - wytłaczająca Big Shot ™ jest wspaniałym narzędziem wprowadzającym do poznania technik nowoczesnego wycinania oraz wytłaczania
- Jej fantastyczne możliwości i funkcjonalność zadowolą zarówno osoby początkujące jak i zaawansowane w rękodziele artystycznym i innych dziedzinach, w których wycinanie i wytłaczanie są technikami pożądanymi lub niezbędnymi
- Wielkość: A5
- Zestaw zawiera:
- Maszynę Big Shot™
- Standardową platformę bazową
- Adapter do cieńkich wykojników
- Standardową parę przezroczystych płytek do wycinania - Cutting Pads
- Ulotkę z opisem produktu, instrukcją użytkowania i procedurą reklamacyjną w j. polskim
- Wykorzystując wykrojniki typu Bigz, Movers & Shapers, Originals i On The Edge można wycinać kształty w papierze, tekturze, tkaninie, skórze, filcu i wielu innych grubszych materiałach
-Wykrojniki Sizzlits, Framelits, Thinlits, Embosslits tną papier i cienki brystol, a foldery do embossingu wytłaczają w papierze, cienkim brystolu, a nawet w grubszej folii aluminiowej lub bardzo cienkiej blasze
- Z pomocą maszyny Big Shot™ oraz wykrojników i folderów do embossingu masz szansę tworzyć niepowtarzalne projekty kreatywne od scrapbookingu i własnoręcznego tworzenia kartek. okolicznościowych, poprzez tworzenie wyjątkowych dekoracji, jak również projektów szytych (np. patchwork), biżuteryjnych czy tworzonych w technikach mieszanych
- Platforma bazowa oraz para standardowych płytek Cutting Pads pozwalają na użycie dowolnej technologii Sizzix®, z wyjątkiem wykrojników z serii Pro
- Za pomocą maszyny Big Shot ™ możesz wycinać i wytłaczać wykorzystując wykrojniki i foldery o różnej grubości
- Niekiedy istnieje konieczność dopasowania grubości pakietu za pomocą przekładek w platformie Multipurpose lub za pomocą dodatkowych akcesoriów np. platformy do cienkich wykrojników Solo Thin Die Adapter.
- Maszyna pozwala wycinać kształty o maksymalnej szerokości 15.2 cm i długości 33cm
- Bezpieczna i łatwa w użyciu, ergonomiczna rączka sprawia, że praca z maszyną jest niezwykle komfortowa i nie wymaga użycia dużego nacisku (siły)
