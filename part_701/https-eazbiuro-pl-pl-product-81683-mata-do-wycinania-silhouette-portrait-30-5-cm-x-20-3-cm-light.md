---
title: "Mata do wycinania silhouette portrait | Zrób zakupy online!"
url: https://eazbiuro.pl/pl/product/81683,mata-do-wycinania-silhouette-portrait-30-5-cm-x-20-3-cm-light
lastmod: 
type: product
---
Mata do wycinania silhouette portrait | Zrób zakupy online!
...
Mata do wycinania silhouette portrait 30,5 cm x 20,3 cm light
...
Żdp-mata do wycinania silhouette portrait 30,5 cm dostępny w eazbiuro.pl! | Wybierz od ręki
...
- Mata (arkusz) Silhouette, 30,5 cm x 20,3 cm - mata pokryta delikatną powłoką lepną
- Dedykowana do wycinania na wylot w bardzo cienkich foliach, papierach samoprzylepnych, papierze ozdobnym o gramaturze poniżej 200g/m2
- Specjalna mata Silhouette dedykowana do wycinania na wylot przy wykorzystaniu plotera tnącego Silhouette PORTRAIT
- Matę należy stosować obligatoryjnie przy wycinaniu w mediach (foliach, papierach) na wylot
- Zadaniem maty jest:
- Utrzymanie wycinanych na wylot elementów graficznych w jednej pozycji
- Zabezpieczenie ostrza noża oraz listwy teflonowej (paska pod nóż) przed mechanicznym uszkodzeniem podczas procesu wycinania na wylot
- Właściwości samoprzylepne (adhezyjne) powierzchni maty sprawiają, że mata jest produktem wielokrotnego zastosowania
- Własności repozycjonujące powierzchni maty została tak dobrane, aby nie pozostawiać śladów na przyklejanych do niej mediach i jednocześnie w szybki, łatwy, estetyczny sposób odkleić wycięte elementy graficzne
- Matę podlega wymianie w momencie utraty przyczepności (lepności)
- Okres eksploatacji maty jest indywidualny i zależy m.in. od:
- Od rodzaju medium w jakim wycinamy
- Nakładów wycinania
- Właściwego dostosowania parametrów cięcia w stosunku do grubości ciętego medium
- W celu wydłużenia eksploatacji maty należy:
- Każdorazowo oczyszczać matę z pozostałości elementów po procesie wycinania
- Po zakończeniu procesu wycinania zabezpieczać matę przed utratą walorów lepnych specjalną folią ochronną (dołączana w zestawie z matą)
- Właściwie dostosowywać parametry cięcia, tj. nacisk noża, wysunięcie ostrza noża w zależności od grubości medium (niewłaściwe dostosowanie wysunięcia ostrza noża lub nacisku noża będzie powodować rysowanie powierzchni roboczej maty)
- Wymiary całkowite: 34,3 cm x 22,6 cm
- Wymiary robocze: 30,5 cm x 20,3 cm
...
Dane producenta
 ...
 ul. Żabikowska 25
62-052 Komorniki Tel: +48 61 222 34 89
Polska 
