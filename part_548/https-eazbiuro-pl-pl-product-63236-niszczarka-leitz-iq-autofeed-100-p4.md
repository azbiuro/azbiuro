---
title: "Niszczarka Leitz iq autofeed | Sprawdź i zamów w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/63236,niszczarka-leitz-iq-autofeed-100-p4
lastmod: 
type: product
---
Niszczarka Leitz iq autofeed | Sprawdź i zamów w A-Z Biuro!
...
Niszczarka Leitz iq autofeed 100, p4
...
Niszczarka Leitz iq autofeed 100, p4 dostępny w eazbiuro.pl! | Sprawdź z darmową wysyłką
...
- Niszczy do 100 kartek A4 jednocześnie, zamieniając dokumenty w drobne,trudne do sklejenia, konfetti  o wymiarach 4x28mm, zapewniając poziombezpieczeństwa DIN P4. 
 
- Niszczy do 100 kartek A4 jednocześnie, zamieniając dokumenty w drobne,trudne do sklejenia, konfetti  o wymiarach 4x28mm, zapewniając poziombezpieczeństwa DIN P4
- Dedykowana do bezpiecznej ochrony bardzo wrażliwych danych
- 34-litrowypojemnik na ścinki niweluje potrzebę jego czestego opróżniania
- Może pracować przez 20 minut bez żadnej przerwy co wpływa na doskonałą wydajność (niszczy w tym czaie wszystkie arkusze znajdujące się wpodajniku)
- Pracuje niezwykle cicho co zapewnia niezakłócony spokój w miejscu pracy(pod warunkiem regularnego stosowania arkuszy Leitz do oliwienia ostrzy
- Technologia zapobiegania zacięciom zatrzymuje urządzenie automatycznie icofa papier, jeżeli w podajniku umieszczonych zostało zbyt wiele arkuszy, cogwarantuje bezproblemową pracę urządzenia.
- Posiada funkcję samooczyszczania (noże odwracają się po każdym użyciu) dzięki której ścinki nie wypadają poza kosz w trakcie jego wysuwania
- Czujnik podczerwieni informuje o potrzebie opróżnienia kosza w celu uniknięcia jego przepełnienia
- Dotykowy panel umożliwia łatwą i intuicyjną obsługę.
- Niszczy karty kredytowe, a także spinacze i zszywacze dzięki czemu nie ma potrzeby ich usuwania przed niszczeniem dokumentów
