---
title: "Bezprzewodowa mysz suretrack™ | Kup bez wychodzenia z domu!"
url: https://eazbiuro.pl/pl/product/65613,bezprzewodowa-mysz-suretrack-dual-niebieska-kensington
lastmod: 
type: product
---
Bezprzewodowa mysz suretrack™ | Kup bez wychodzenia z domu!
...
Bezprzewodowa mysz suretrack™ dual, niebieska dostępny w eazbiuro.pl! | Złap z szybkim odbiorem
...
- Mysz bezprzewodowa SureTrack™ Dual, biała Mysz bezprzewodowa SureTrack™ Dual z podwójnym bezprzewodowym łączem zwiększy Twoją produktywność dzięki możliwości pracy na różnych powierzchniach, dostępnym opcjom łączności, zabezpieczeniom i możliwości personalizacji
- Jako pierwsza niskoprofilowa mysz oferuje elastyczne opcje łączności bezprzewodowej (2,4 GHz oraz Bluetooth 3.0 i Bluetooth 5.0), dzięki czemu obsługuje szeroką gamę urządzeń komputerowych
- Mysz SureTrack™ Dual zapewnia również precyzyjne śledzenie na najtrudniejszych powierzchniach oraz możliwość obsługi obiema rękami za pomocą 3 przycisków
- Wyposażona jest w 128-bitowe szyfrowanie AES, przełącznik z 3 ustawieniami DPI pozwalający na wygodną zmianę szybkości kursora oraz wysokiej jakości ciche przyciski
- Dostępna w wielu opcjach kolorystycznych. mysz, mysz komputerowa, mysz bezprzewodowa, mysz biurowa, mysz przenośna, płaska mysz, mysz na bluetooth, mysz kensington Podróżuj z myszą, tak nieograniczoną, jak Ty
- Teraz spodziewaj się więcej od swojej myszy bezprzewodowej
- Zapewnia wiele opcji parowania - możesz połączyć się przez Bluetooth lub poprzez klucz USB-A Nano, 2,4 GHz.
- Możliwość bezprzewodowego połączenia z laptopem lub innym urządzeniem mobilnym za pośrednictwem Bluetooth 3.0 lub 5.0 (Bluetooth LE) pozwala zaoszczędzić port USB
- Możliwość bezprzewodowego połączenia z komputerem stacjonarnym za pomocą klucza 2,4 GHz USB-A Nano
- Wydajny czujnik optyczny szybko i dokładnie śledzi ruchy wykonywane myszą
- Pracuje precyzyjnie nawet na najtrudniejszych powierzchniach stosowanych we współczesnych biurach, takich jak szkło, granit, lakier, marmur i drewno
- Spełnia wymogi korporacyjnych protokołów bezpieczeństwa, a dzięki zastosowaniu technologii szyfrowania (poziom zabezpieczeń rządowych) chroni dane przed potencjalnymi hakerami
- Możliwość łatwej zmiany szybkości kursora poprzez wybór odpowiedniego poziomu DPI
- Wybierz jedną z dostępnych rozdzielczości: 1200, 2400 lub 4000 DPI - wyższa rozdzielczość DPI przeznaczona jest do swobodnego przeglądania internetu lub pracy z dokumentami, niższa - do precyzyjnego operowania myszką
- Przeznaczona do komputerów PC posiadających lub nieposiadających funkcji Bluetooth oraz nowszych urządzeń z Bluetooth LE, takich jak Surface Pro i MacBook Pro
- Kompatybilna z systemem Windows, Chrome OS, macOS i Android OS
