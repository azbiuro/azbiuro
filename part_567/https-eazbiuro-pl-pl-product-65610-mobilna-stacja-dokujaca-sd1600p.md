---
title: "Mobilna stacja dokująca | Skorzystaj z atrakcyjnej ceny!"
url: https://eazbiuro.pl/pl/product/65610,mobilna-stacja-dokujaca-sd1600p
lastmod: 
type: product
---
Mobilna stacja dokująca | Skorzystaj z atrakcyjnej ceny!
...
Mobilna stacja dokująca (sd1600p)
...
Mobilna stacja dokująca (sd1600p) dostępny w eazbiuro.pl! | Skorzystaj już teraz
...
- Mobilna stacja dokująca Kensington SD1600P USB-C z gniazdem zasilania 
- W dzisiejszych czasach pracownicy mobilni zmieniają często miejsce pracy i muszą korzystać zarówno ze starych, jak i nowych technologii
- Dzięki mobilnej stacji dokującej Kensington SD1600P USB-C 4K z gniazdem zasilania użytkownicy mogą podłączyć do swojego laptopa wyświetlacz - Full HD (VGA) lub 4K (HDMI) oraz akcesoria USB za pomocą dwóch portów USB 3.0, jednocześnie ładując swoje urządzenie
- Niezależnie od tego, czy będziesz w tymczasowym miejscu pracy, czy w sali konferencyjnej, stacja dokująca zapewni Ci większą funkcjonalność oraz możliwość ładowania laptopa
- Wszechstronna i kompaktowa przenośna stacja dokująca z USB-C dla osób często przemieszczających się 
- Idealna dla urządzeń przenośnych z portem USB-C, które wymagają dodatkowych portów do podłączenia urządzeń peryferyjnych, a także monitorów i projektorów obsługujących obraz w rozdzielczości do 4K
- Technologia połączenia: USB-C Alt Mode
- USB-C Power Delivery: obsługuje USB-C PD 3.0 (ładowanie laptopa z mocą 60 W)
- Kompatybilny z systemem operacyjnym Windows® 7 lub nowszym, macOS® 10.13 lub nowszym, Chrome OS™ 44 lub nowszym
- Porty wideo: 1 x HDMI v1.4 i 1 x HD VGA
- Liczba obsługiwanych monitorów: 1
- Rozdzielczość - jeden monitor: HDMI UHD 3840 x 2160 przy 30 Hz lub VGA Full HD 2048 x 1152 przy 60 Hz
- Instalacja Plug & Play nie wymaga sterowników i pobierania (MacOS i Windows 7 wymagają jednorazowego pobrania sterownika)
- Wymagania systemowe: urządzenie hosta musi obsługiwać Power Delivery i DisplayPort Alt Mode przez USB-C
