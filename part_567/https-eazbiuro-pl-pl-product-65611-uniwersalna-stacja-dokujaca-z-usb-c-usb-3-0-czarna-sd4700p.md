---
title: "Uniwersalna stacja dokująca z | Skorzystaj z oferty teraz!"
url: https://eazbiuro.pl/pl/product/65611,uniwersalna-stacja-dokujaca-z-usb-c-usb-3-0-czarna-sd4700p
lastmod: 
type: product
---
Uniwersalna stacja dokująca z | Skorzystaj z oferty teraz!
...
Uniwersalna stacja dokująca z usb-c, usb 3.0, czarna (sd4700p)
...
Uniwersalna stacja dokująca z usb-c, usb 3.0, cz dostępny w eazbiuro.pl! | Dodaj do zamówienia dziś
...
- Uniwersalna stacja dokująca Kensington SD4700P USB-C i USB 3.0 
- Wykorzystując najnowsze technologie i przedłużając jednocześnie żywotność stacji, w które już wcześniej zainwestowałeś
- Kensington zaprojektował uniwersalną stację dokującą SD4700P USB-C i USB 3.0 bazując na najbardziej zaufanych i stabilnych rozwiązaniach
- Mogąca obsłużyć najnowsze komputery z portami USB-C oraz starsze urządzenia z portami USB 3.0, stacja SD4700P USB-C i 3.0 to idealne rozwiązanie dokujące dla firm przechodzących na standard USB-C
- Ładowanie starszych modeli laptopów wyposażonych w USB 3.0 przez stację dokującą SD4700P jest możliwe jedynie za pośrednictwem rozdzielacza zasilania K38310EU (sprzedawany osobno) 
- Stacja SD4700P idealnie sprawdzi się w firmach przechodzących na porty USB-C i posiadających także laptopy z USB 3.0
- Uniwersalną stację dokującą SD4700P można podłączyć do dowolnego laptopa wyposażonego w porty USB-C lub USB 3.0, kompatybilnego z systemami operacyjnymi Windows i/lub Mac
- Stacja dokująca SD4700P przekazuje dźwięk, wideo, dane i zasilanie (tylko przez USB-C) za pomocą jednego kabla, zapewniając wolne od bałaganu, funkcjonalne miejsce pracy
- Zasilanie przez port USB-C z obsługą Power Delivery
- Kompatybilny z USB-C PD 3.0 (ładowanie laptopa z mocą 60W)
- Stacja wyposażona jest w porty: 1 x HDMI v1.3, 1 x DisplayPort v1.1 ++; maksymalna rozdzielczość: pojedynczy monitor - 2560 x 1600 przy 60 Hz, dwa monitory - 2048 x 1152 przy 60 Hz
- Bezpłatne oprogramowanie Kensington DockWorks™ zapewnia najlepszą wydajność, bezpieczeństwo oraz łączność ze stacją dokującą Kensington
- Instalacja typu Plug & Play: wymagana instalacja sterownika DisplayLink. Pobierz oprogramowanie z witryny kensington.com lub przez aktualizację Windows
- Wymagania systemowe: Port USB-C w urządzeniu hosta musi obsługiwać Power Delivery
- Dostarczanie energii nie jest możliwe na urządzeniach hosta wyposażonych w USB 3
- Gwarancja: 3 lata
