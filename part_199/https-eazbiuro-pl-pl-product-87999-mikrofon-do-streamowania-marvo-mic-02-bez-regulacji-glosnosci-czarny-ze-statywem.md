---
title: "Mikrofon do streamowania Marvo | Sprawdź dostępność online!"
url: https://eazbiuro.pl/pl/product/87999,mikrofon-do-streamowania-marvo-mic-02-bez-regulacji-glosnosci-czarny-ze-statywem
lastmod: 
type: product
---
Mikrofon do streamowania Marvo | Sprawdź dostępność online!
...
Mikrofon do streamowania Marvo mic-02, bez regulacji głośności, czarny, ze statywem
...
Mikrofon do streamowania Marvo mic-02, bez regul dostępny w eazbiuro.pl! | Odbierz z rabatem
...
- Mikrofon Marvo MIC-02 - nieograniczony streaming
- Bez względu na to czym się zajmujesz, czy prowadzisz stream, czy nagrywasz własne filmy dobrze jest mieć odpowiedni mikrofon
- Wybierz sprzęt Marvo MIC-02, który na pewno Cię nie zawiedzie
- Mikrofon, który potrafi odróżniać skomplikowane detale akustyczne, potrafi odbierać sygnały ze wszystkich kierunków, gwarantuje wysokiej jakości nagrywanie dźwięków oraz zapewnia niskie zniekształcenia
- Tym właśnie cechuje się Marvo MIC-02
- Mikrofon łatwo daje się zamontować na statyw, który posiada metalowe nóżki
- Do przytrzymywania mikrofonu w miejscu służą gumowe opaski, jednocześnie zapobiegają rozchodzeniu się hałasu w przypadku uderzenia w statyw
- Bez gumowych opasek przenoszony byłby hałas mikrofonu uderzający o ściany statywu
- Mikrofon daje także możliwość zablokowania na statywie pod dowolnym kątem
- Do mikrofonu dołączony jest też 10 centymetrowy filtr POP
- Chroni on mikrofon przed głośnym oddechem i śliną oraz służy do tłumienia tzw. //"wybuchowych spółgłosek//"
- Filtr można zamocować do statywu za pomocą metalowego ramienia, które można zablokować w dowolnej odległości od mikrofonu 
- Dane techniczne:
- Typ mikrofonu: dookólny
- Rozmiar mikrofonu: 6 x 5 mm
- Stosunek sygnału do szumu: -36 dB
- Zakres częstotliwości: 50 Hz - 16 KHz
- Czułość mikrofonu: -38 dB ± 3 dB
- Impedancja: 2,2 K
- Połączenie: gniazdo jack 3,5 mm
- Długość kabla: 1,5 m
