---
title: "Klawiatura mecHaniczna Marvo kg925g, | Wybierz w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/87976,klawiatura-mechaniczna-marvo-kg925g-przewodowa-usb-podswietlona
lastmod: 
type: product
---
Klawiatura mecHaniczna Marvo kg925g, | Wybierz w A-Z Biuro!
...
Klawiatura mecHaniczna Marvo kg925g, przewodowa (usb), podświetlona
...
Klawiatura mecHaniczna Marvo kg925g, przewodowa dostępny w eazbiuro.pl! | Złap od ręki
...
- Marvo KG925G to klawiatura mechaniczna zaprojektowana tak, aby sprostać potrzebom najbardziej wymagających graczy
- To połączenie wysokiej jakości wykonania z efektownym wzornictwem, które robi wrażenie i pasuje do pokoju każdego gracza
- Klawiatura wykonana została z wysokiej jakości tworzywa ABS i metalowej płyty
- Komfort użytkowania zapewnia bardzo szerokie (zdejmowane) wsparcie nadgarstków
- Funkcja Anti-ghosting zapobiega blokowaniu się klawiatury, przy wciśnięciu wielu przycisków jednocześnie
- To ułatwienie, które pozwala na niezawodną pracę podczas jednoczesnego wykonywania wielu poleceń w grach
- Dla graczy istotną funkcją klawiatur gamingowych jest również jej podświetlenie
- Nocna rozgrywka na mechanicznej klawiaturze Marvo KG925G przy zgaszonym świetle nie stanowi problemu, a podświetlenie LED zmniejsza prawdopodobieństwo pomylenia klawiszy
- Typ przełącznika: Mechaniczny
- Liczba klawiszy: 104
- Skok klawisza: 3,8 ± 0,2 mm
- Siła aktywacji: 60 ± 5 g
- Podświetlenie: RGB
- Interfejs: USB 2.0
- Długość kabla: 1,75 m
- Obsługa systemu operacyjnego: Windows 7 i nowsze 
