---
title: "Zestaw Marvo cm305, klawiatura | Sprawdź ofertę już dziś!"
url: https://eazbiuro.pl/pl/product/87959,zestaw-marvo-cm305-klawiatura-membranowa-mysz-sluchawki-dla-graczy-cz-sk-do-gry-rgb
lastmod: 
type: product
---
Zestaw Marvo cm305, klawiatura | Sprawdź ofertę już dziś!
...
Zestaw Marvo cm305, klawiatura membranowa + mysz + słuchawki DLa graczy, cz/sk, do gry, rgb
...
Zestaw Marvo cm305, klawiatura membranowa + mysz dostępny w eazbiuro.pl! | Zamów z rabatem
...
- Profesjonalny zestaw dla graczy CM305 składa się z klawiatury membranowej z kolorowym podświetleniem, kompaktowej i precyzyjnej myszy gamingowej o czułości do 4800 DPI, nowoczesnych słuchawek z systemem audio 7.1 virtual surround pozwalających z niewiarygodną precyzją określić kierunek docierającego dźwięku
- Fantastyczna klawiatura  Marvo z serii Pro umożliwia wprowadzenie kombinacji złożonej z aż 26 klawiszy wciśniętych jednocześnie. Do tego możemy dołożyć klawisze multimedialne, ułatwiające obsługę gier czy filmów. Dużą zaletą jest również bardzo ciche działanie, które na pewno docenią Ci, którzy lubią strzelać, polować, eksplorować i rywalizować po zmroku
- Twórcy klawiatury skupili się nie tylko na jej jakości oraz trwałości, ale również na ergonomii, dodając tym samym specjalną podpórkę pod nadgarstki
- Niezależnie od tego w jaką grę grasz lub z jakim przeciwnikiem masz do czynienia z M513 zawsze znajdziesz odpowiednie ustawienia
- Myszka wyposażona jest w precyzyjny czujnik optyczny o rozdzielczości 4800 DPI, który zapewnia dużą szybkość i dokładność
- Dedykowane oprogramowanie pozwala skonfigurować i zaprogramować mysz zgodnie z osobistymi preferencjami
- W ten sposób można ustawić stopnie czułości do 4800 DPI i łatwo zaprogramować szczegółowe makropolecenia dla 7 przycisków
- Można także wybierać różne kolory podświetlenia z palety RGB lub zmieniać częstotliwość raportowania USB
- Wyprofilowany kształt dopasowany do prawej dłoni zapewnia naturalne ułożenie dłoni w wygodnej pozycji, a dostosowane przyciski znajdują się w zasięgu palców
- Konstrukcja przycisków odznacza się niebywałą trwałością, a jej żywotność szacuje się na 3 mln kliknięć
- Nowoczesne słuchawki z systemem audio 7.1 virtual surround pozwalających z niewiarygodną precyzją określić kierunek docierającego dźwięku
- Ponadto dzięki dynamice głośników na poziomie 105 dB, paśmie przenoszenia 20 Hz - 20 KHz jak również impedancji 32 Ohm, gracz otrzymuje głęboki dźwięk o doskonałej jakości
- Słuchawki Marvo CM305 zapewniaj wygodę, poprzez miękkie i duże pady nauszników, które zostały pokryte eko-skórą
- Mikrofon jest na tyle elastyczny, że wygina się w każdej płaszczyźnie - Słuchawki działają na zasadzie plug & play i sterowane są za pomocą prostego i intuicyjnego pilota na kablu
- DANE TECHNICZNE KLAWIATURY: 
- Ilość klawiszy: 114
- Typ: Membranowa
- Żywotność klawiszy: 10 milionów kliknięć
- Skok klawiszy (pełny): 3,6 ± 0,2 mm
- Siła aktywacji: 52 ± 7 gramów
- Podświetlenie: Mieszane kolory (Rainbow)
- Interfejs: USB 2.0
- Długość kabla: 1,5 m
- Antighosting: 26-klawiszowy
- Klawisze multimedialne: odtwarzanie multimediów, uruchamianie e-mail, internetu kalkulatora, itd
- Rozmiar: 461 x 198 x 37 mm
- DANE TECHNICZNE MYSZKI:
- Czujnik: Optyczny
- DPI: 800-1600-2400-3200-4000-4800
- Przyciski: 8 (programowalne)
- Żywotność klawiszy: 5 milionów kliknięć
- Podświetlenie: RGB
- Interfejs: USB 2.0
- Długość kabla: 1,5 m
- Boki zapobiegające ślizganiu
- Rozmiar: 131 x 70 x 42 mm
- DANE TECHNICZNE SŁUCHAWEK:
- Dźwięk: Wirtualny dźwięk przestrzenny 7.1
- Pasmo przenoszenia: 20 Hz - 20 KHz
- Rozmiar głośnika: 50 mm
- Czułość głośnika: 105dB ± 3dB
- Impedancja głośników: 32 omy
- Typ mikrofonu: Dookólny
- Rozmiar mikrofonu: 4x1,5 mm
