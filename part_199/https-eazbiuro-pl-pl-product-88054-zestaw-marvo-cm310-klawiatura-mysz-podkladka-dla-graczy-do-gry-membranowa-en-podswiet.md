---
title: "Zestaw Marvo cm310 klawiatura + | Kliknij i zamów od ręki!"
url: https://eazbiuro.pl/pl/product/88054,zestaw-marvo-cm310-klawiatura-mysz-podkladka-dla-graczy-do-gry-membranowa-en-podswietlenie-rgb
lastmod: 
type: product
---
Zestaw Marvo cm310 klawiatura + | Kliknij i zamów od ręki!
...
Zestaw Marvo cm310 klawiatura + mysz + podkładka DLa graczy, do gry, membranowa, en, podświetlenie rgb
...
Zestaw Marvo cm310 klawiatura + mysz + podkładka dostępny w eazbiuro.pl! | Kup i odbierz jeszcze dziś
...
- Zestaw dla gracza Marvo CM310
- Klawiatura dla tych co lubią ciszę
- Klawiatura membranowa TKL znajdująca się zestawie gamingowym CM310 nawiązuje swoim designem, podświetleniem, konstrukcją i wysokością klawiszy do klawiatur mechanicznych
- Oferuje ona jednak znacznie cichsze działanie co jest szczególnie pożądane w trakcie długich nocnych rozgrywek
- Konstrukcja samych przełączników została wzmocniona dzięki czemu klawiatura pozostanie z użytkownikiem na dłuższy czas
- Żywotność przełączników oszacowana została na 10 mln uderzeń
- W klawiaturze CM310 wykorzystano 3 kolorowe diody LED z możliwością zmiany w 3 trybach podświetlenia
- Klawiatura także umożliwia zmianę jasności podświetlenia
- W trakcie gry użytkownik może rozświetlić efektownie klawiaturę natomiast w trakcie oglądania filmu zmniejszyć lub wyłączyć całkowicie jej podświetlenie 
- Drugim elementem zestawu to niezwykle udana gamingowa myszka Marvo M359 RGB
- M359 to mysz gamingowa o nisko profilowanym uchwycie
- Wymiary 127 x 66 mm, obustronne wcięcie niewielka waga, około 90g, pozwalają na wygodne uchwycenie myszy i precyzyjne prowadzenie w trakcie rozgrywki nie zależnie od ulubionego chwytu gracza
- Mysz została wyposażona w sensor optyczny RTT3168 o maksymalnej rozdzielczości 3200 DPI
- Zarówno sensor jak i 7 przycisków posiada możliwość konfiguracji dzięki dołączonemu do myszy dedykowanemu oprogramowaniu
- Kolejnym dużym atutem myszy Marvo M359 jest jej charakterystyczne wyglądające podświetleniem RGB ukryte w dolnej krawędzi myszy
- Co ważne podświetlenie to umożliwia regulację kolorów w palecie aż 16 milionów barw
- W zestawie gamingowym CM310 zadebiutowała podkładka z nową szatą graficzną i nowym logo Marvo
- W odróżnieniu od dotychczas stosowanych w zestawach Marvo podkładka posiada symetryczny kształt o wymiarach 28x23 cm
- Utrzymana jest w czarnej kolorystyce z niewielkim dodatkiem czerwieni
- DANE TECHNICZNE KLAWIATURY:
- Klawiatura CM310 TKL
- Typ: membranowy
- Liczba klawiszy: 87 
- Żywotność przełączników: do 10 mln kliknięć
- Podświetlenie: 3 kolory 
- Liczba trybów podświetlenia: 3 + regulacja jasności
- Anti-ghosting: 25
- Wymiary: 372 x 151 x 37 mm
- Waga: 580 g
...
- Przyciski: 7 (programowalne)
- Żywotność: 3 miliony kliknięć
 - Podświetlenie: RGB 16 mln kolorów
 - Odpytywanie: max 1000 Hz
 - Złącze: USB 2.0
 - Waga: 90 g
 - Długość przewodu: 1,5 m
 - Wymiary: 127 x 66 x 39 mm
 - OS: Windows 7 lub wyższy
- DANE TECHNICZNE PODKŁADKI:
- Tkanina o wysokiej gęstości
