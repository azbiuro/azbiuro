---
title: "Klawiatura mecHaniczna Marvo | Sprawdź ofertę już dziś!"
url: https://eazbiuro.pl/pl/product/87969,klawiatura-mechaniczna-marvo-kg965g-przewodowa-usb-podswietlenie-rgb
lastmod: 
type: product
---
Klawiatura mecHaniczna Marvo | Sprawdź ofertę już dziś!
...
Klawiatura mecHaniczna Marvo kg965g, przewodowa (usb), podświetlenie rgb
...
Klawiatura mecHaniczna Marvo kg965g, przewodowa dostępny w eazbiuro.pl! | Zgarnij w super promocji
...
- Mechaniczna klawiatura multimedialna do gier Marvo KG965G z niebieskimi przełącznikami i regulacją głośności na pokrętle zachwyci każdego gracza
- Stalowa podstawa i wysokiej jakości ABS zapewniają klawiaturze niezbędną wytrzymałość
- Aby uzyskać atrakcyjny wygląd Marvo KG965G oferuje podświetlenie RGB z indywidualnym podświetleniem dla każdego klawisza i ponad 10 schematów podświetlania
- Klawiatura wyposażona jest również w 6 klawiszy makr i zawiera szeroki zdejmowany podłokietnik
- Dzięki oprogramowaniu możliwe jest precyzyjne dostrojenie klawiatury do własnych upodobań, a dzięki pełnemu antighostingu nie utkniesz w najważniejszym momencie
- Jeśli potrzebujesz makr do swoich gier, możesz zapisać do 6 różnych klawiszy G1-G6
- Polecenia, dla których zwykle trzeba nacisnąć kilka klawiszy, teraz można wykonać naciskając tylko jeden klawiszMultimedia + pokrętło regulacji głośności
- Dla łatwej obsługi odtwarzacza multimedialnego, dostępu do kalkulatora, internetu lub folderu nasza klawiatura obsługuje 12 klawiszy multimedialnych
- Bardzo praktyczną rzeczą jest regulacja głośności na pokrętle, które znajduje się w prawym górnym rogu klawiatury
- Jeśli chcesz dostosować klawiaturę do swoich potrzeb bez wątpienia docenisz oprogramowanie, które pozwala przypisać własną funkcję do wybranych klawiszy - Możesz także dostroić podświetlenie lub nagrywać makra za pomocą oprogramowania
- 2 x wyjście USB
- Z tyłu klawiatury znajdują się 2 wyjścia USB obok kabla zasilającego
- Możesz wygodnie ładować swój smartfon lub tablet 
- Wyjścia mogą również służyć jako hub USB do podłączenia np. Dysku flash
-  Ilość klawiszy: 119
- Typ: Membranowa 
- Żywotność klawiszy: 50 milionów kliknięć
- Antighosting: N-key rollover
- Klawisze makr
- Klawisze umożliwiające wejście do własnego obszaru podświetlenia
- Oprogramowanie
- 2 x wyjście USB
- Siła nacisku: 60 ± 15 g
- Podświetlenie: RGB
- Łączność: USB 2.0
- Długość kabla: 1,6 m
- Kompatybilny z: Windows 7 lub nowszy
