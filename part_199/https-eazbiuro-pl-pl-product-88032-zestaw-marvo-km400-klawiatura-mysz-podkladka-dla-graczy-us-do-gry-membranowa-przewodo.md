---
title: "Zestaw Marvo km400, | Skorzystaj z atrakcyjnej ceny!"
url: https://eazbiuro.pl/pl/product/88032,zestaw-marvo-km400-klawiatura-mysz-podkladka-dla-graczy-us-do-gry-membranowa-przewodowa-usb-czarna-podswietlana
lastmod: 
type: product
---
Zestaw Marvo km400, | Skorzystaj z atrakcyjnej ceny!
...
Zestaw Marvo km400, klawiatura+mysz+podkładka DLa graczy, us, do gry, membranowa, przewodowa (usb), czarna, podświetlana
...
Zestaw Marvo km400, klawiatura+mysz+podkładka DL dostępny w eazbiuro.pl! | Złap w wyjątkowej ofercie
...
- Zestaw 3w1 klawiatura, mysz oraz podkładka Marvo KM400+G1
- Wychodząc naprzeciw potrzebom graczy, przygotowany został specjalny, wysokiej jakości zestaw, który składa się z:
klawiatury, myszki oraz podkładki pod mysz
- Klawiatura posiada opcję podświetlanych klawiszy w trzech kolorach do wyboru
- Funkcja anti-ghostingu umożliwia wyprowadzenie kombinacji złożonej z aż 19 klawiszy wciśniętych jednocześnie
- Ergonomiczna budowa klawiatury zapewnia niezwykłą wygodę korzystania
- Podświetlana mysz Marvo została wyposażona w
precyzyjny sensor optyczny z przełączaną rozdzielczością 800 / 1200 / 1600 / 2400 DPI umożliwiającą dokładne pozycjonowanie kursora w grach
- Ergonomiczny kształt produktu oraz materiały użyte do jego wykończenia zapobiegają zmęczeniu dłoni podczas użytkowania
- Wierzch podkładki Marvo pokryty został miękką tkaniną zapewniającą wygodne podparcie nadgarstka, natomiast spód z antypoślizgowej gumy gwarantuje świetną przyczepność nawet podczas najbardziej emocjonującej gry
- Podkładka współpracuje z każdym rodzajem sensora
- SPECYFIKACJA MYSZY:
- Czujnik: optyczny
...
- Obsługa anti-ghosting dla 19 klawiszy
- Liczba klawiszy: 114
- Typ klawiatury: membrana
- Skok klawisza: 3,6 ± 0,3 mm
- Podświetlenie: 3 kolory
- Interfejs: USB 2.0
- Długość kabla: 1,5 m
- SPECYFIKACJA PODKŁADKI:
- Konstrukcja zapobiegająca poceniu się dłoni
- Rozmiar: 287 x 244 x 3 mm
