---
title: "Tablica do Bigowania kart i kopert | Odkryj pełną ofertę!"
url: https://eazbiuro.pl/pl/product/80912,tablica-do-bigowania-kart-i-kopert
lastmod: 
type: product
---
Tablica do Bigowania kart i kopert | Odkryj pełną ofertę!
...
Tablica do Bigowania kart i kopert
...
Tablica do Bigowania kart i kopert dostępny w eazbiuro.pl! | Sprawdź w limitowanej ofercie
...
- Tablica do bigowania kart i kopert z dwu funkcyjnym dziurkaczem narożnikowym i wzorami do wytłaczania
- Doskonałe narzędzie, dzięki któremu w łatwy i szybki sposób stworzysz równe i profesjonalne linie zagięć podczas tworzenia kartek okolicznościowych i zaproszeń oraz piękne koperty w różnych rozmiarach 
- Zestaw zawiera: tablicę do bigowania, dwufunkcyjny dziurkacz narożnikowy, narzędzie do bigowania, wygładzania i wytłaczania
- Rozmiar: tablica: 16 cm x 21,5 cm, obszar roboczy: 14 cm x 18 cm
 
Wyjątkowe atuty:
- Tablica jest funkcjonalna z obu stron; jedna strona służy do zaginania kart a druga do tworzenia kopert
- Narzędzie (kość) do zaginania i wygładzania zagiętych linii umieszczona jest w specjalnym miejscu na tablicy
- Uniwersalne wzory służące do wytłaczania dekoracyjnych akcentów w projekcie
- Instrukcja obługi znajduje się na opakowaniu oraz jako nadruk na tablicy
- Linijki oraz tabele pomiarowe w centymetrach i calach
- Dwufunkcyjny dziurkacz narożnikowy w komplecie - łatwo stworzysz zaokrąglone narożniki i wcięcia bez pomocy nożyczek
- Niewielki format tablicy sprawia, że jest łatwa do przechowywania oraz doskonale sprawdza się w podróży, podczas warsztatów i twórczych spotkań
