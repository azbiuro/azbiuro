---
title: "Zestaw Stabilo pastellove pen 68 + point | Dodaj do koszyka!"
url: https://eazbiuro.pl/pl/product/113883,zestaw-stabilo-pastellove-pen-68-point-88-boss-mini-pastel-18-elementow
lastmod: 
type: product
---
Zestaw Stabilo pastellove pen 68 + point | Dodaj do koszyka!
...
Zestaw Stabilo pastellove pen 68 + point 88 + boss mini pastel 18 elementów
...
Zestaw Stabilo pastellove boss mini, point 88 mini dostępny w eazbiuro.pl! | Zamów w świetnej cenie
...
- Zestaw 18 elementów Stabilo Pastellove
- W zestawie znajduje się 6 zakreślaczy, 6 cienkopisów oraz 6 flamastrów
 
Zakreślacze Boss Mini
- Stabilo Boss to niekwestionowany lider na rynku zakreślaczy
- Wysoce ceniony przez bardzo szerokie grono użytkowników, którzy nie wyobrażają sobie biurka bez tego produktu
- Zakreślacz w pastelowych kolorach z tuszem na bazie wody
- Niezwykle uniwersalny, odpowiedni do pisania na wszystkich rodzajach papieru
- Nie wysycha pozostawiony bez skuwki przez okres nawet 4 godzin
- Wyposażony w charakterystyczną, ściętą końcówkę, dzięki której mamy możliwość pisania dwoma grubościami kreski
- W zestawie 6 kolorów
- Trwały, nieblaknący tusz na bazie wody
- Ergonomiczny kształt korpusu
- Idealny do papieru, kserokopii i faksu
- Końcówka: ścięta
- Grubość linii pisania: 2 - 5 mm
 
Flamastry 68 Mini
- Ergonomiczna, sześciokątna konstrukcja zapewnia mocny uchwyt podczas użytkowania
- Bezwonny tusz na bazie wody zapewnia wyraziste, dobrze nasycone kolory
- Kolor obudowy dopasowany do koloru tuszu
- Mocna, zaokrąglona końcówka pozwala kreślić linię 1 mm
- Posiada wentylowaną skuwkę.
- W zestawie 6 kolorów
- Błyszczące, metaliczne kolory (w tym złoty, srebrny i miedziowy)
- Szerokość linii pisma: 1 mm
- Idealne do rysowania, dekorowania i letteringu
- Dzięki tuszowi na bazie wody kolory nie blakną pod wpływem światła
- Świetnie nadają się do pisania po gładkich powierzchniach (papier, metal, folia, szkło)
 
Cienkopisy Point 88 Mini
- Stabilo Point 88 to znany i lubiany wielozadaniowiec wyróżniający się solidnością i wytrzymałością
- Wyposażony w mocną, oprawioną w metal fibrową końcówkę odporną na złamania i rozwarstwienia, co gwarantuje wysoki standard kreślenia aż do całkowitego wyczerpania tuszu
- Cienkopis doskonale kooperuje z linijkami szablonami zapewniając przejrzystą, równą linię
- Tusz na bazie wody nie wysycha przez długi czas, nawet pozostawiony bez skuwki
- Absolutny niezbędnik w każdym biurze i domowym przyborniku.
- W zestawie 6 kolorów
- Szerokość linii: 0.4 mm
- Na każdym cienkopisie skuwka w kolorze pisma
