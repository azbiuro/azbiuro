---
title: "Kalkulator Eleven CT500 | Dodaj do zamówienia teraz!"
url: https://eazbiuro.pl/pl/product/133209,kalkulator-eleven-ct500
lastmod: 
type: product
---
Kalkulator Eleven CT500 | Dodaj do zamówienia teraz!
...
- Kalkulator Eleven CT-500VII posiada jasny i czytelny 10-cyfrowy wyświetlacz LCD, który ułatwia odczytywanie wyników
- Ergonomiczne klawisze umożliwiają wygodne wprowadzanie danych i szybkie wykonywanie obliczeń
- Ten kalkulator biurowy oferuje podstawowe funkcje matematyczne, takie jak dodawanie, odejmowanie, mnożenie, dzielenie i obliczanie procentów
- Możesz przeprowadzać różnorodne obliczenia z dokładnością i skutecznością
- 10-cyfrowy wyświetlacz
- automatyczny tryb uśpienia
- podwójnie zasilany (bateria oraz bateria słoneczna)
- [%] Procenty
- [MU] Obliczanie marży
- [00] Podwójne zero
- [√] Pierwiastek kwadratowy
- [+/-] Zmiana znaku
- [TAX] Obliczanie podatków
- sprawdź i popraw do 99 kroków
- pamięć 3-klawiszowa: MRC,  M+, M-
