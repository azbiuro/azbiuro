---
title: "Podwójna ładowarka | Odbierz z ekspresową dostawą!"
url: https://eazbiuro.pl/pl/product/93789,podwojna-ladowarka-bezprzewodowa-qi-2x10w-type-c
lastmod: 
type: product
---
Podwójna ładowarka | Odbierz z ekspresową dostawą!
...
Podwójna ładowarka bezprzewodowa qi 2x10w type-c
...
Podwójna ładowarka bezprzewodowa qi 2x10w type-c dostępny w eazbiuro.pl! | Skorzystaj z gwarancją jakości

Opis produktu
Podwójna ładowarka bezprzewodowa Qi 
 
- Moc 10W*2 
- Ładowanie dwóch urządzeń jednocześnie 
- Technologia Qi 
- USB Type-C 
- Antypoślizgowa podkładka 
- Wskaźnik LED 
- Zabezpieczenie przed przeładowaniem i przegrzaniem 
 
SZYBKA ŁADOWARKA 10W 
 
Ładowarka indukcyjna PWCDB pozwala ładować bezprzewodowo urządzenia z mocą aż do 10W, co pozwala zaoszczędzić nawet do 60 minut w stosunku do standardowej ładowarki Qi. 
 
ŁADUJ DWA URZĄDZENIA JEDNOCZEŚNIE 
 
Podkładka ładująca pozwala na bezprzewodowe ładowanie dwóch urządzeń jednocześnie, z pełną mocą 10W. 
 
NAŁADUJE TEŻ TWÓJ SMARTFON 
 
Ładowarka jest kompatybilna ze wszystkimi smartfonami wyposażonymi w funkcję bezprzewodowego ładowania w standardzie Qi. Przykładowe wspierane modele to: iPhone (11, 11 Pro, XS, XS Max, XR, X, 8, 8 Plus), Samsung Galaxy (S9, S9+, S8, S8+, S7, S7 Edge), Huawei (P20 Pro, P30 Pro) i inne. 
 
GWARANCJA BEZPIECZEŃSTWA 
 
Urządzenie wspiera wszystkie niezbędne normy, certyfikaty i zabezpieczenia pozwalające na wydajne i bezpieczne korzystanie z urządzenia. Używanie ładowarki PWCDB jest w pełni bezpieczne dla smartfonów. 
 
WYGODNA KONSTRUKCJA 
 
Ładowarka sprawdzi się na każdym biurku, ponieważ w przeciwieństwie do podkładek ładujących, umożliwia wygodne korzystanie i podgląd powiadomień na smartfonie. Gumowe stopki i antypoślizgowa powierzchnia gwarantują odpowiednie zabezpieczenie ładowanego urządzenia. Minimalistyczna obudowa sprawdzi się w każdym wnętrzu, a dyskretny wskaźnik LED informuje użytkownika o aktualnym stanie ładowania. 
...
Wyjście: DC 9V/1A 
Moc: 10W*2 
Zawartość opakowania: ładowarka bezprzewodowa, instrukcja obsługi 
