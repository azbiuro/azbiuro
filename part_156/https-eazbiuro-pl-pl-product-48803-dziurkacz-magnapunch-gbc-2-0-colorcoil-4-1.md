---
title: "Dziurkacz magnapunch GBC, 2.0 | Dodaj do zamówienia teraz!"
url: https://eazbiuro.pl/pl/product/48803,dziurkacz-magnapunch-gbc-2-0-colorcoil-4-1
lastmod: 
type: product
---
Dziurkacz magnapunch GBC, 2.0 | Dodaj do zamówienia teraz!
...
Dziurkacz magnapunch GBC, 2.0 colorcoil, 4:1
...
Dziurkacz magnapunch GBC, 2.0 colorcoil, 4:1 dostępny w eazbiuro.pl! | Skorzystaj w promocyjnej cenie
...
- Dziurkacz GBC zaprojektowało nową wyższą pojemność Magnapunch 2.0 z ewolucyjną technologią wykrywania brzegu która zapewnia że dokumenty są idealnie dziurkowane tak za pierwszym jak i za każdym następnym razem
- Kolorowy wyświetlacz LCD
- Ewolucyjna technologia wykrywania krawędzi
- Praktycznie wyeliminowane zacięcia dzięki systemowi wczesnego ostrzegania
- Ciągła praca z półsekundowym cyklem dziurkowania
- Wysoka prędkość dzięki silnemu silnikowi pozawala na dziurkowanie maksymalnie 49 000 arkuszy na
godzinę
- 13 wysokowydajnych modułów tnących
- Ze zwiększoną o 70% zdolnością dziurkowania oraz łatwo i szybko instalowanymi modułami Magnapunch2.0
zaspokoi wszystkie Twoje wymagania
- Łatwa w użyciu prowadnica brzegu oraz przezroczysta osłona noży tnących
- Pozwala operatorowi w zachowaniu dokładności i kontroli przez cały czas pracy
 
- Zestaw matryc GBC MagnaPunch 2.0 ColorCoil 4: 1 .2475 - 7705634
- Twórz dokumenty o doskonałej jakości dzięki szerokiej gamie wymiennych zestawów matryc, które są dostępne do użytku z MagnaPunch 2.0. 
- Należą do nich Color Coil, Wire Bind, CombBind, ProClick, Looseleaf, SureBind i VeloBind, co ułatwia zmianę wzorów wykrawania bez zmiany maszyn
- Te matryce maszynowe do stempla elektrycznego GBC MagnaPunch 2.0 są łatwe w instalacji i nie wymagają narzędzi. Kołki matrycy są łatwo dostępne, co pozwala na obsługę wielu różnych rozmiarów dokumentów
