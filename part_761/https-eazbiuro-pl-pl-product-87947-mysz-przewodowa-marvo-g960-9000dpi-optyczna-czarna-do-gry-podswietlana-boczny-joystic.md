---
title: "Mysz przewodowa Marvo g960, | Odbierz w najlepszej cenie!"
url: https://eazbiuro.pl/pl/product/87947,mysz-przewodowa-marvo-g960-9000dpi-optyczna-czarna-do-gry-podswietlana-boczny-joystick-12-klawiszy
lastmod: 
type: product
---
Mysz przewodowa Marvo g960, | Odbierz w najlepszej cenie!
...
Mysz przewodowa Marvo g960, 9000dpi, optyczna, czarna, do gry, podświetlana, boczny joystick, 12 klawiszy
...
Mysz przewodowa Marvo g960, 9000dpi, optyczna, c dostępny w eazbiuro.pl! | Chwyć z szybkim odbiorem
...
- Myszka gamingowa MARVO G960 to bezkompromisowa myszka optyczna z joystickiem przeznaczona dla osób praworęcznych
- Precyzyjny sensor optyczny Pixart 3325 o maksymalnej rozdzielczości 9000 DPI oraz prędkość raportowania 
na poziomie 1000 Hz pozwoli na zdominowanie przeciwnika szybkością i precyzją
- Myszka oferuje 2 tryby użytkowania: jeden przeznaczony do pracy biurowej, a drugi do gier
- Subtelne podświetlenie RGB znajdujące się na obwodzie urządzenia jest wystarczające, aby nadać myszce drapieżnego, futurystycznego wyglądu, a zarazem jest na tyle delikatne, że nie przeszkadza w czasie pracy biurowej. - Specjalne oprogramowanie pozwala zaprogramować przyciski, podświetlenie, rozdzielczość oraz nagrywać makra
- Tryby: Myszka oferuje dwa tryby użytkowania: pierwszy przeznaczony do gier oraz drugi do pracy biurowej. 
- Można je zmieniać za pomocą przełącznika znajdującego się na spodzie urządzenia
- Tryby posiadają wstępnie ustawione funkcje dla każdego przycisku, co pozwala na komfortową pracę już na starcie
- W trybie biurowym przyciski mają ustawione domyślne skróty klawiaturowe, takie jak: Ctrl+C, Ctrl+V, Ctrl+X, Enter, Delete
- Tryb gry został wstępnie ustawiony dla PUBG
- Oprogramowanie: W Marvo G960 gracz otrzymuje zaawansowane oprogramowanie z możliwością przypisania dowolnych funkcji do każdego z 12 przełączników myszy, edycji profili i makr, ustawienia ulubionych wartości DPI oraz dopasowania swoich ulubionych kolorów do poziomów DPI
- Dane techniczne:
- Czujnik: optyczny, Pixart 3325
- Rozdzielczość: 800/1600/2400/3200/4000/5000/7000/9000 DPI (domyślnie), poprzez oprogramowanie 200 - 10000 DPI
- Liczba przycisków: 12 (programowalne)
- Żywotność przycisków: 20 milionów kliknięć
- Podświetlenie: RGB
- Joystick po lewej stronie myszy
- Częstotliwość: 1000 Hz
- Interfejs: USB 2.0
- Długość kabla: 1,5 m
- Wymiary: 120 x 71 x 43 mm
