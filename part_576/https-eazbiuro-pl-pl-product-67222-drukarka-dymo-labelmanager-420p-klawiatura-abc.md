---
title: "Drukarka Dymo labelmanager | Zamów dziś – odbierz szybko!"
url: https://eazbiuro.pl/pl/product/67222,drukarka-dymo-labelmanager-420p-klawiatura-abc
lastmod: 
type: product
---
Drukarka Dymo labelmanager | Zamów dziś – odbierz szybko!
...
Drukarka Dymo labelmanager 420p, klawiatura abc
...
Drukarka Dymo labelmanager 420p, klawiatura abc dostępny w eazbiuro.pl! | Skorzystaj z rabatu od ręki
...
- Wysokowydajna drukarka etykiet wyposażona w złącze PC
- Drukarka etykiet Dymo LabelManager 420P to bez wątpienia najlepszy wybór dla użytkowników, którzy polegają na etykietach w celu uczynienia miejsca pracy wydajnym i efektywnym
- Pracuje samodzielnie lub z komputerem po podłączeniu za pośrednictwem portu USB 2.0, co pozwala na edycję ekranową i drukowanie
- Możliwość pracy autonomicznej lub podłączenia do komputera PC i wykorzystania oprogramowania Dymo LabelSoftware do drukowania kodów kreskowych, logotypów, serii etykiet z plików baz dnych i wielu innych
- Duży, 4-wierszowy wyświetlacz graficzny prezentuje efekty czcionki przed drukowaniem
- Inteligentne klawisze zapewniają błyskawiczny dostęp do większości popularnych funkcji formatowania, takich jak rozmiar czcionki, wytłuszczenie, druk pionowy, podkreślenie i tekst w obramowaniu.
- Klawisze skrótów do najczęściej używanych i najpopularniejszych funkcji: rozmiaru czcionki, pogrubienia, drukowania w pionie, podkreślania i obramowania
- Klawisze szybkiego dostępu do symboli i znaków diakrytycznych (np. ę, ą, ć…), klawiatura typu ABC
- Funkcja automatycznego wyłączania umożliwia oszczędzanie baterii
- Pamięć ostatnio wydrukowanej etykiety
- Prosta nawigacja od menu głównego do opcji wydruku
- Przyjazna klawiatura ułatwia wprowadzanie tekstu
- Zasilanie przy pomocy akumulatora litowo-jonowego (dołączony) oraz zasilacza sieciowego (w zestawie)
- Gwarancja 24 miesiące
- Do drukarki dołączono taśmę D1 19mm x 3 m czarny napis na białym tle
