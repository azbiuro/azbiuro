---
title: "Adapter usb-c do aux | Skorzystaj z atrakcyjnej ceny!"
url: https://eazbiuro.pl/pl/product/93811,adapter-usb-c-do-aux
lastmod: 
type: product
---
Adapter usb-c do aux | Skorzystaj z atrakcyjnej ceny!
...
adapter usb-c do aux dostępny w eazbiuro.pl! | Zamów bez czekania

Opis produktu
PMMA9824 PLATINET SMARTPHONE ADAPTER TYPE-C TO AUX - to adapter zaprojektowany dla telefonów z gniazdem typu USB C, nie posiadających gniazda AUX 3,5mm. Pozwala on na podłączenie słuchawek z wejściem AUX 3,5mm. 

Niewielki rozmiar pozwala na zabranie go praktycznie wszędzie. Jest on niezbędnym elementem ekwipunku osób które uwielbiają mobilnie słuchać muzyki, a poprzez ograniczenia związane ze zamianą technologiczną straciły możliwość używania swoich ulubionych słuchawek. 
Teraz nie musisz kupować nowych słuchawek, wystarczy przejściówka PMMA9824. 
Produkt nie jest kompatybilny w laptopami z wejściem USB-C. 

Specyfikacja:

Interfejs produktu: typ C, 3,5 mm
Materiał powłoki: ABS
Długość produktu: 100 mm
