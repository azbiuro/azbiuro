---
title: "Szyfrowany pendrive usb 3.0 64 | Sprawdź dostępność online!"
url: https://eazbiuro.pl/pl/product/93812,szyfrowany-pendrive-usb-3-0-64-gb-metalowa-obudowa
lastmod: 
type: product
---
Szyfrowany pendrive usb 3.0 64 | Sprawdź dostępność online!
...
Szyfrowany pendrive usb 3.0 64 gb, metalowa obudowa
...
Szyfrowany pendrive usb 3.0 64 gb, metalowa obud dostępny w eazbiuro.pl! | Zamów w super promocji

Opis produktu
W czasach powszechnej cyfryzacji i wszechobecnego dostępu do Internetu bezpieczeństwo danych zyskuje wysoki priorytet. Niezależnie, czy mówimy o plikach związanych z pracą zawodową, czy o prywatnych zdjęciach i filmach z wakacji - warto zadbać o ich odpowiednie zabezpieczenie.

Wybierając PLATINET PENDRIVE USB 3.0 PIN-DEPO METAL ENCRYPTED o pojemności 64 GB zapewnisz swoim danym bezpieczeństwo na najwyższym poziomie.

Pendrive marki PLATINET to podwójne zabezpieczenie: dostęp do danych jest możliwy po wprowadzeniu kodu PIN, a dane są szyfrowane. Wpisanie kodu PIN umożliwia wbudowana klawiatura. Nośnik pozwala ustawić kod o długości w zakresie od 6 do 15 cyfr. Po wyjęciu pamięci z gniazda USB pendrive jest automatycznie blokowany. Z kolei szyfrowanie danych odbywa się zgodnie ze standardem AES256, w dodatku bezpośrednio na nośniku pamięci. Dlaczego to tak istotne? Szyfrowanie bezpośrednio w pamięci sprawia, że w systemie operacyjnym komputera nie pozostanie żaden ślad kodu, którym zabezpieczysz urządzenie.

PENDRIVE PLATINET USB 3.0 PIN-DEPO METAL ENCRYPTED jest kompatybilny z dowolnym urządzeniem wyposażonym w porty USB 2.0 lub USB 3.0. Współpracuje z każdym systemem operacyjnym i nie wymaga instalowania sterowników.
