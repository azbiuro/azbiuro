---
title: "Cienkopis kreślarski Uni PIN-200 | Wybierz w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/132881,cienkopis-kreslarski-uni-pin-200-pedzelek-czarny-extra-fine
lastmod: 
type: product
---
Cienkopis kreślarski Uni PIN-200 | Wybierz w A-Z Biuro!
...
Cienkopis kreślarski Uni PIN-200 pędzelek czarny, extra fine
...
Cienkopis kreślarski Uni PIN-200 pędzelek czarny dostępny w eazbiuro.pl! | Odbierz w super promocji

Opis produktu
Cienkopis kreślarski z pędzelkiem Pin Brush 200 marki Uni został stworzony do szkicowania, precyzyjnego kreślenia, rysowania oraz pisma ręcznego. Jest idealny dla grafików, projektantów oraz artystów.
 elastyczna końcówka pędzelkowa, która pozwala tworzyć gładkie, płynne pociągnięcia
 będzie doskonałym wykończeniem rysunków wykonanych kredkami oraz farbami, które potrzebują dodania drobnych szczegółów
 pisak zawiera pigmentowy atrament na bazie wody, który nie przesiąka przez papier
 zapewnia on wygodne i bezwysiłkowe pisanie
 cienkopis jest odporny na działanie wody, słońca, alkoholu, amoniaku i rozpuszczalników
