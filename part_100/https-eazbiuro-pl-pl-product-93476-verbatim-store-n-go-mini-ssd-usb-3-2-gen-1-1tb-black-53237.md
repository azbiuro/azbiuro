---
title: "Verbatim store 'n' go mini | Odbierz z ekspresową dostawą!"
url: https://eazbiuro.pl/pl/product/93476,verbatim-store-n-go-mini-ssd-usb-3-2-gen-1-1tb-black-53237
lastmod: 
type: product
---
Verbatim store "n" go mini | Odbierz z ekspresową dostawą!
...
Verbatim store "n" go mini ssd usb 3.2 gen 1 1tb black 53237
...
Verbatim store "n" go mini ssd usb 3.2 gen 1 1tb dostępny w eazbiuro.pl! | Sprawdź z darmową wysyłką

Opis produktu
Omówienie
Dysk SSD Store 'n' Go Mini to idealna pamięć dla użytkowników pozostających w ruchu. Ten dysk SSD to szybkie i bezpieczne rozwiązanie do przechowywania i tworzenia kopii zapasowych plików; jest niebywale lekki i mały – zaledwie 35 gramów w stylowej, czarnej obudowie 3D.

Duża wydajność
Dysk SSD jest zgodny z systemami operacyjnymi komputerów PC i Mac. Gniazdo USB 3.2 GEN 1 zapewnia bardzo dużą prędkość transmisji danych. Dysk pozwala na szybki transfer dużej ilości danych, dzięki czemu idealnie nadaje się do edycji filmów, przenoszenia dużych plików lub zwiększania wydajności gier. Zestaw zawiera przewód Micro-B –> USB-A, jak również przejściówkę USB-A –> USB-C umożliwiającą podłączanie wielu różnych urządzeń.

Niezawodność i bezpieczeństwo
Dysk SSD Store 'n' Go Mini wykorzystuje pamięć Flash, oferując wysoką prędkość transmisji i dużą wydajność. Dyski SSD nie posiadają ruchomych części, dzięki czemu są bardziej trwałe, bezgłośne i zużywają mniej energii!

Niewielkie rozmiary, duża pojemność
Zaprojektowany dla użytkowników laptopów dysk SSD Store 'n' Go Mini jest lekki i mały. Waży zaledwie 35 gramów przy długości poniżej 7,5 cm – jest tak mały, że zmieścisz go nawet w tylnej kieszeni jeansów! Niewielkie rozmiary pomagają wytrzymać codzienne przypadkowe uderzenia, aby dysk działał wszędzie tam, gdzie tego potrzebujesz.

Oprogramowanie Nero Backup
W celu zwiększenia poziomu bezpieczeństwa z dyskiem dostarczane jest oprogramowanie Nero Backup, za pomocą którego można łatwo i w dowolnym momencie wykonać kopię zapasową wszystkich plików, folderów i napędów znajdujących się w komputerze lub laptopie. Możliwe jest również zaplanowanie automatycznego wykonywania kopii zapasowych na wybrany czas, dzięki czemu kopie zapasowe będą tworzone regularnie! Program do tworzenia kopii zapasowych Nero Backup jest zgodny wyłącznie z systemem operacyjnym Windows.

*Faktyczna prędkość transferu zależy od rozmiaru pliku, wydajności komputera i wersji systemu operacyjnego

Szczegóły produktu
Niezwykle mały i lekki dysk półprzewodnikowy
Przenośna konstrukcja i waga zaledwie 35 gramów
Stylowa, czarna obudowa z powierzchnią 3D
Szybka transmisja danych – szybkie i bezpieczne rozwiązanie pozwalające zwiększyć przestrzeń dyskową i archiwizować pliki
Połączenie USB 3.2 GEN 1 ze złączem USB-C™
Przewód Micro-B do USB-A z przejściówką USB-A do USB-C™ w zestawie
Oprogramowanie do tworzenia kopii zapasowych Nero Backup (tylko system Windows)

Wymagania systemowe
Gniazdo hosta USB 3.2 GEN 1 (zgodne również ze standardem USB 2.0**)
Windows 10, 8, 7
Mac OS X 10.6 lub nowsza wersja

 

**w celu uzyskania optymalnego działania dysk musi być podłączony do sterownika hosta USB 3.2 GEN 1.

Dane techniczne
Zasilanie: magistrala zasilana przewodem USB
Interfejs: USB 3.2 GEN 1
Materiał obudowy: plastik
Masa produktu: 35 gramów (około)
Wymiary: 74,8 mm x 54 mm x 12,5 mm (dł. x szer. x wys.)

Zawartość opakowania
Minidysk półprzewodnikowy
Przewód Micro-B do USB-A (zawiera przejściówkę USB-A do USB-CTM)
Oprogramowanie do tworzenia kopii zapasowych Nero Backup (kompatybilne tylko z systemem operacyjnym Windows)
Oprogramowanie do formatowania (kompatybilne tylko z systemem operacyjnym Windows)
Skrócona instrukcja obsługi 
Podręcznik użytkownika (zapisany na dysku)
