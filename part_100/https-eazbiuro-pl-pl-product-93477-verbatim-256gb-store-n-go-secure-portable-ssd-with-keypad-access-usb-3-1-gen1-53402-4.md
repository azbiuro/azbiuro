---
title: "Verbatim 256gb store 'n' go | Zrób wygodne zakupy online!"
url: https://eazbiuro.pl/pl/product/93477,verbatim-256gb-store-n-go-secure-portable-ssd-with-keypad-access-usb-3-1-gen1-53402-468
lastmod: 
type: product
---
Verbatim 256gb store "n" go | Zrób wygodne zakupy online!
...
Verbatim 256gb store "n" go secure portable ssd with keypad access usb 3.1 gen1 53402-468
...
Verbatim 256gb store "n" go secure portable ssd dostępny w eazbiuro.pl! | Kup już teraz

Opis produktu
W obecnych czasach bezpieczeństwo poufnych danych ma znaczenie krytyczne. Wyobraź sobie utratę osobistych plików na skutek pozostawienia dysku w pociągu lub taksówce i świadomość, że każdy może uzyskać do nich dostęp, ponieważ zostały zapisane na zwyczajnym dysku. Już dostępny bezpieczny dysk Store 'n' Go Secure SSD z dostępem z klawiatury zapewni Ci spokój ducha.

256-bitowe szyfrowanie sprzętowe AES płynnie szyfruje wszystkie dane na dysku w czasie rzeczywistym, a wbudowana klawiatura chroni dysk za pomocą hasła. Dysk nie zapisuje haseł na komputerze ani w pamięci ulotnej systemu, dzięki czemu jest to rozwiązanie znacznie bezpieczniejsze od szyfrowania programowego. W przypadku dostania się w niepowołane ręce dysk zostanie zablokowany i po 20 nieudanych próbach wprowadzenia hasła będzie wymagać ponownego formatowania.

Dysk SSD Secure 'n' Go z dostępem z klawiatury korzysta z pamięci typu flash oferującej większą szybkość i wyższą wydajność niż tradycyjne dyski twarde. Dyski SSD nie mają ruchomych części, dzięki czemu są bardziej niezawodne, bezgłośne i zużywają mniej energii!

Dysk jest zgodny z systemami operacyjnymi PC i Mac i wyposażony w interfejs USB 3.1 GEN 1 ze złączem USB-C w celu zapewnienia bardzo dużych szybkości transmisji danych*. Zestaw zawiera przewód USB-C do USB-A, jak również adapter USB-A do USB-C umożliwiający podłączenie do wielu różnych urządzeń. Dysk można również podłączyć do telewizora, co jest niemożliwe w przypadku dysków z normalnym szyfrowaniem.

W celu zwiększenia poziomu bezpieczeństwa z dyskiem dostarczane jest oprogramowanie Nero Backup, za pomocą którego można łatwo i w dowolnym momencie wykonać kopię zapasową wszystkich plików, folderów i napędów znajdujących się w komputerze lub laptopie. Możliwe jest również zaplanowanie automatycznego wykonywania kopii zapasowych na wybrany czas, dzięki czemu kopie zapasowe będą tworzone regularnie! Oprogramowanie Nero Backup jest zgodne z systemami Windows Vista, Windows 7, Windows 8 i Windows 10 (nie jest zgodne z systemami operacyjnymi Mac)

256-bitowe szyfrowanie sprzętowe AES, płynne szyfrowanie wszystkich danych na dysku w czasie rzeczywistym
...
Możliwość używania z telewizorem (funkcja niedostępna w przypadku dysków z normalnym szyfrowaniem)
USB 3.1 GEN 1 ze złączem USB-C™ 
Przewód USB-C™ do USB-A (z przejściówką USB-A do USB-C™)
Kontrolki LED zasilania / stanu szyfrowania
Nie zapisuje haseł na komputerze ani w pamięci ulotnej systemu, dzięki czemu jest to rozwiązanie znacznie bezpieczniejsze od szyfrowania programowego
Zgodność z komputerami PC i Mac
Obudowa wykonana z aluminium i tworzywa sztucznego
...
System Mac OS X 10.4 lub nowszy

*w celu uzyskania optymalnego działania dysk musi być podłączony do sterownika hosta USB 3.1 GEN 1

Dane techniczne
Zasilanie: Z magistrali przez przewód USB
Interfejs: USB 3.1 GEN 1
Materiał obudowy: Aluminium i tworzywo sztuczne
Kontrolka LED: Zasilanie, aktywność dysku HDD / SSD i stan szyfrowania
Masa produktu: ok. 116 gramy
Wymiary: 93 mm x 50 mm x 13 mm (dł. x szer. x wys.)
Temperatura podczas pracy: Od 5°C do 50°C
Temperatura podczas przechowywania: Od -40°C do 70°C
Wilgotność podczas pracy: Od 5 do 90%, bez kondensacji

Zawartość opakowania
Bezpieczny przenośny dysk Store 'n' Go Secure Portable SSD z dostępem z klawiatury
Przewód USB-CTM do USB-A (zawiera adapter USB-A do USB-CTM)
Oprogramowanie Nero Backup (niezgodne z systemami operacyjnymi Mac)
