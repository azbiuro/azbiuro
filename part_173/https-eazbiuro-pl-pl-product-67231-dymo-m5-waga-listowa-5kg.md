---
title: "Dymo m5 waga listowa 5kg | Zamów w najlepszej cenie!"
url: https://eazbiuro.pl/pl/product/67231,dymo-m5-waga-listowa-5kg
lastmod: 
type: product
---
Dymo m5 waga listowa 5kg | Zamów w najlepszej cenie!
...
Dymo m5 waga listowa 5kg dostępny w eazbiuro.pl! | Dodaj do zamówienia dziś
...
- Możliwość ważenia listów i paczek o maksymalnym ciężarze do 5 kg
- Możliwość określania opłat pocztowych na podstawie ciężaru - bez potrzeby kupowania znaczków "na wyrost"
- Dzięki kompaktowym wymiarom 23,4 x 21,1,1 x 4,6 cm (dł. x szer. x wys.) mieści się na każdym biurku i pasuje do większości szuflad biurowych
- Na ekranie jest LCD jest wyświetlana informacja o ciężarze w łatwym do odczytania formacie. Dostępne jednostki to kg/g (kilogram/gram) lub lb/oz (funt/uncja)
- Funkcja "Hold" pozwala zablokować wyświetlacz na dziesięć sekund po zdjęciu przedmiotu, co jest przydatne podczas ważenia szerokich przesyłek, w momencie kiedy wyświetlacz jest zasłonięty
- Funkcja "Tara" pozwala ważyć przedmiot w pojemniku z pominięciem ciężaru samego pojemnika
- Funkcja automatycznego wyłączenia po okresie bezczynności pozwala oszczędzać baterie
- Zasilana 3 bateriami typu AAA (niedołączone) lub za pośrednictwem kabla USB po podłączeniu do komputera PC (w zestawie)
- Obsługa systemów Windows XP, Vista, Windows 7, Windows 8, Windows 10 lub Mac OS v10.4 lub nowszy 
