---
title: "Drukarka etykiet rhino 4200, | Zamów dziś – odbierz szybko!"
url: https://eazbiuro.pl/pl/product/67293,drukarka-etykiet-rhino-4200-zestaw-walizkowy
lastmod: 
type: product
---
Drukarka etykiet rhino 4200, | Zamów dziś – odbierz szybko!
...
Drukarka etykiet rhino 4200, zestaw walizkowy
...
Drukarka etykiet rhino 4200, zestaw walizkowy dostępny w eazbiuro.pl! | Zamów ekspresowo
...
- Dzięki klawiaturze QWERTY, klawiszom skrótów i innym funkcjom pozwalającym oszczędzić czas, drukarka Rhino 4200 pozwala wykonać zadanie szybko i dokładnie.
- Klawiatura typu komputerowego ułatwia i przyspiesza wprowadzanie tekstu.
- Opatentowane klawisze skrótów HOT KEYS umożliwiają tworzenie i formatowanie owijek na przewody, flag, kodów kreskowych Code 39 i Code 128 oraz etykiet ogólnych i modułowych o stałej długości.
- Możliwość drukowania kolorowych etykiet wykonanych z różnych materiałów oraz drukowania na rurkach termokurczliwych.
- Klawisz "Ulubione" zapewnia dostęp do najczęściej używanych etykiet i symboli i terminów za pomocą jednego klawisza.
- Obsługę ułatwia klawisz ustawień własnych, do którego można przypisać ustawienia dla poszczególnych formatów etykiet.
- Zaprogramowana fabrycznie biblioteka zapewnia dostęp do 150 symboli i terminów z zakresu bezpieczeństwa, elektryczności, audio/wideo i zarządzania infrastrukturą.
- Zintegrowane gumowe osłony chronią przed uszkodzeniem w przypadku upadku z niskiej wysokości.
- Duży wyświetlacz z funkcją podświetlenia ułatwia odczyt nawet przy słabym oświetleniu.
- Funkcja automatycznego wyłączenia zapewnia dłuższą żywotność baterii bez utraty danych.
- Zasilanie 6 bateriami AA (niedołączone), oraz możliwość podłączenia akumulatora litowo - jonowego.
- W zestawie z drukarką: taśma startowa 12mm x 5,5m biała winylowa. walizka, zasilacz sieciowy, bateria litowo-jo
