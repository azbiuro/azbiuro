---
title: "Platinet microsdxc secure | Wybierz jakość A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/93582,platinet-microsdxc-secure-digital-adapter-sd-128gb-class10-u3-a1-90mb-s-42910
lastmod: 
type: product
---
Platinet microsdxc secure | Wybierz jakość A-Z Biuro!
...
Platinet microsdxc secure digital + adapter sd 128gb class10 u3 A1 90mb/s [42910]
...
Platinet microsdxc secure digital + adapter sd 1 dostępny w eazbiuro.pl! | Sprawdź już teraz

Opis produktu
Karty pamięci Platinet serii PRO są odpowiedzią na zmieniający się rynek przenośnych nośników danych. Najnowsze oznaczenie A1 oznacza, że karta pamięci świetnie sprawdzi się jako bardzo wydajne rozszerzenie pamięci w smartfonie. Użytkownik może z powodzeniem przechodywać na niej dane, aplikacje, zdjęcia, filmy z gwarancją płynnej pracy urządzenia. 
 
NAJWAŻNIEJSZE INFORMACJE 
 
- Klasa A1: 1500 IOPS (odczyt), 500 IOPS (zapis) 
- zapis do 90 MB/S 
- standard microSDXC 
- w zestawie adapter SD 
- pojemność: 128 GB 
 
IDEALNA DO MULTIMEDIÓW 
 
Klasa A1 ("App Performance") gwarantuje wydajną pracę jako rozszerzenie pamięci w smartfonach. Dane aplikacji, gry, płynne nagrywanie wideo w rozdzielczości 4K, magazynowanie zdjęć i wideo - to zadania, z którymi bezproblemowo poradzi sobie karta serii PRO. 
 
WIDEO 4K 
 
Prędkość zapisu wynosząca do 90 MB/S pozwala na płynne rejestrowanie nagrań w wysokiej rozdzielczości 4K. Karta pamięci poradzi sobie też z obszernymi zdjęciami w formacie RAW. 
 
Przeczytaj:
 Kupujemy dobrą kartę pamięci do smartfona - na jakie parametry trzeba zwrócić uwagę?a>
