---
title: "Bindownica Fellowes lyra 3 w 1 | Skorzystaj z oferty teraz!"
url: https://eazbiuro.pl/pl/product/66253,bindownica-fellowes-lyra-3-w-1
lastmod: 
type: product
---
Bindownica Fellowes lyra 3 w 1 | Skorzystaj z oferty teraz!
...
Bindownica Fellowes lyra 3 w 1
...
bindownica Fellowes lyra 3 w 1 dostępny w eazbiuro.pl! | Wybierz okazję i zamów szybko
...
Fellowes Lyra 3 w 1 to funkcjonalne i wytrzymałe centrum oprawy dokumentów grzbietami plastikowymi (bindowanie, zszywanie i dziurkowanie dokumentów w jednym urządzeniu) do użytku w małym biurze: 
- umożliwia jednoczesne dziurkowanie do 20 kartek A4 (80g) i oprawę dokumentu o grubości do 300 arkuszy o maksymalnej średnicy grzbietu 38 mm, 
- funkcjonalna: system dziurkowania pionowego umożliwia niezależne dziurkowanie i nakładanie dokumentów na grzbiet, 
- wyposażona w mechanizm do dziurkowania kartek (2 lub 4 otwory) do archiwizacji w segregatorach oraz zszywacz EasyPress™, który pozwala na zszycie do 30 arkuszy papieru (można stosować zszywki w rozmiarze 24/6 i 26/6), 
- wytrzymała: wyposażona w solidny, metalowy mechanizm dziurkowania i zszywania, 
- ergonomiczna: wyposażona w szufladę do przechowywania grzbietów z opatentowanym systemem mierzenia grubości dokumentów i doboru odpowiedniego grzbietu oraz szufladę na ścinki, 
- prosta w obsłudze: wyśrodkowanie linii dziurkowania za pomocą suwaka ułatwia użytkowanie, a obustronna dźwignia dziurkowania zmniejsza siłę nacisku potrzebną do przedziurkowania pliku kartek. 
- W pakiecie z bindownicą komplet 1000 zszywek do spięcia dokumentów. 
