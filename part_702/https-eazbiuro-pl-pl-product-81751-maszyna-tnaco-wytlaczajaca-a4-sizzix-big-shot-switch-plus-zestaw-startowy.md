---
title: "Maszyna tnąco - wytłaczająca A4 | Wybierz tanio i wygodnie!"
url: https://eazbiuro.pl/pl/product/81751,maszyna-tnaco-wytlaczajaca-a4-sizzix-big-shot-switch-plus-zestaw-startowy
lastmod: 
type: product
---
Maszyna tnąco - wytłaczająca A4 | Wybierz tanio i wygodnie!
...
Maszyna tnąco - wytłaczająca A4 - sizzix big shot switch plus - zestaw startowy
...
Żdp-maszyna tnąco - wytłaczająca A4 - sizzix big s dostępny w eazbiuro.pl! | Sprawdź i skorzystaj już dziś
...
MASZYNA W PRZEDSPRZEDAŻY DOSTĘPNA OD 1 Kwartał/2021
 
- Big Shot Switch Plus Starter Kit to wyjątkowy pakiet zawierający elektryczną maszynę do wycinania i wytłaczania oraz dodatkowe akcesoria jak wykrojniki i narzędzia
- W tej wersji urządzenie, po uruchomieniu jednym przyciśnięciem guzika wytnie i wytłoczy wiele fantazyjnych wzorów
- Niemal bezgłośnie pracujący silnik wzmocniony został dodatkowymi metalowymi przekładniami, które zapobiegają zacinaniu się używanych materiałów
- Maszyna posiada zabezpieczenie przed przeciążeniem, jest energooszczędna i bezpieczna w użytkowaniu
- Urządzenie Big Shot Switch Plus jest kompatybilne z niemal wszystkimi wykrojnikami i szablonami Sizzix (z wyłączeniem Bigz Pro)
...
- Płaszczyzna cięcia jest składana, dzięki czemu można łatwo i szybko tworzyć nowe projekty,a następnie schować gdyż nie zabiera dużo miejsca po złożeniu
- Maszyna posiada specjalne uchwyty do łatwego transportu
- Dodatkowo jest ukryty schowek, który umożliwia przechowywanie cienkich wykrojników i innych akcesoriów wraz z maszyną
- Wielkość: A4
- Wymiary: 38,10 x 14,92 x 16,51 cm
- Max szerokość materiału: 20.3 cm i długości 27.9 cm.
- Co w zestawie:
- Maszyna + platforma bazowa
- Para przezroczystych płytek do wycinania
- Adapter A i B
- Wykrojniki Thinlits - 24 szt
- Folder do embosingu 3D - textured impression - 1 szt
- Narzędzie do czyszczenia cienkich wykrojników z magnesem
- Podkładka z pianki 11,43 x 18x42 x 1,27 cm
- Igła do wykrojników
