---
title: "Drukarka Dymo labelmanager | Kup online bez wychodzenia!"
url: https://eazbiuro.pl/pl/product/10124,drukarka-dymo-labelmanager-lm500ts-z-ekranem-dotykowym
lastmod: 
type: product
---
Drukarka Dymo labelmanager | Kup online bez wychodzenia!
...
Drukarka Dymo labelmanager lm500ts z ekranem dotykowym
...
Drukarka Dymo labelmanager lm500ts z ekranem dot. dostępny w eazbiuro.pl! | Sprawdź od ręki
...
- Duży, kolorowy ekran dotykowy – poraz pierwszy w drukarce etykiet DYMO! Łatwe tworzenie, edytowanie i formatowanie za pomocą funkcji dotykowych
- Szybkie wprowadzanie tekstu na komputerowej klawiaturze QWERTY
- Dzięki automatycznej obcinarce zapomnisz o ręcznym rozcinaniu
- Modyfikuj etykiety dzięki ogromnej liczbie możliwości w postaci 10 rodzajów czcionek, 25 rozmiarów czcionek, 32 stylów tekstu, 5 obramowań i 100 wbudowanych symboli or clipartów
- Drukuj czytelne grafiki, kody kreskowe i logo w rozdzielczości 300 dpi
- Podłącz urządzenie do komputera PC i modyfikuj czcionki lub grafiki na etykietach za pomocą oprogramowania DYMO Label™ Software – możliwe jest również pobieranie elementów w celu edycji i szybkiego drukowania
- Udostępniaj bez utraty ustawień – nowe profile użytkowników umożliwiają zachowywanie etykiet, ustawień i danych dla 5 różnych użytkowników
- Przechowywanie ponad 500 etykiet w urządzeniu
- Szybkie etykietowanie – dwukrotnie większa szybkość pracy niż w przypadku pozostałych drukarek etykiet DYMO
- Zapomnij o kosztach związanych z bateriami jednorowymi i konieczności ich utylizacji - korzystaj z zestawu ładowalnych akumulatorów
- Obsługa taśm DYMO D1 o szerokości: 6, 9, 12, 19 i 24 mm
- W zestawie znajduje się urządzenie LabelManager™ 500TS, zestaw ładowalnych akumulatorów, kabel USB, startowa kaseta z białą taśmą 24 mm D1 do czarnego nadruku, instrukcja szybkiej instalacji, karta rejestracyjna i karta gwarancyjna
