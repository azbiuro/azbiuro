---
title: "Ładowarka baterii pro charge + 4 | Sprawdź ofertę już dziś!"
url: https://eazbiuro.pl/pl/product/18360,ladowarka-baterii-pro-charge-4-akumulatorki-aa-power-plus
lastmod: 
type: product
---
Ładowarka baterii pro charge + 4 | Sprawdź ofertę już dziś!
...
Ładowarka baterii pro charge + 4 akumulatorki aa power plus
...
akcesoria ładowarka baterii pro charge + 4szt. dostępny w eazbiuro.pl! | Zamów w świetnej cenie
...
- Ładowarka Energizer® Universal to uniwersalna ładowarka do akumulatorków dla całej rodziny.
- Ładuje pięć najpopularniejszych rozmiarów akumulatorów AA, AAA, C, D i 9V
- Umożliwia szybkie, bezpieczne ładowanie baterii AA lub AAA w czasie od 3 do 5 godzin
- 2 podwójne kanały ładowania
- Automatyczny wyłącznik czasowy chroniący przed przeładowaniem
- Ochrona przed przebiegunowaniem
- Panel LCD z wskaźnikiem baterii informującym o użyciu właściwego  akumulatorka (zamiast baterii lub zużytego akumulatorka) oraz diodami LED  komunikującymi proces ładowania
...
Produkty, które mogą Cię zainteresować
 ...
 Ładowarka uniwersalna 632959 Energizer 
...
+
 ...
 Ładowarka Energizer base + 4 sztuki akumulaTorków aa 
...
+
 ...
 Ładowarka Energizer universal, czarna 
...
+
 ...
 Ładowarka Energizer base + 4 szt. akumulaTorków aa 
...
+
 ...
 Ładowarka Energizer mini + 2 sztuki akumulaTorków power plus aa 
