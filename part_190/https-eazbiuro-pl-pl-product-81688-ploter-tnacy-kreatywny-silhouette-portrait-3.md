---
title: "Ploter tnący kreatywny | Odbierz z ekspresową dostawą!"
url: https://eazbiuro.pl/pl/product/81688,ploter-tnacy-kreatywny-silhouette-portrait-3
lastmod: 
type: product
---
Ploter tnący kreatywny | Odbierz z ekspresową dostawą!
...
Ploter tnący kreatywny silhouette portrait-3
...
Żdp-ploter tnący kreatywny silhouette portrait-3 dostępny w eazbiuro.pl! | Zgarnij w niskiej cenie
...
- Silhouette PORTRAIT 3 to najmniejszy z ploterów marki Silhouette
- Idealny do niewielkiej pracowni, świetny jako uniwersalne przenośne urządzenie
- To mały podręczny ploter tnący formatu A4
- Dzięki specjalnej konstrukcji, zastosowanym aplikacjom oraz bogatemu oprogramowaniu posiada olbrzymie możliwości
- Trzypunktowy odczyt znaczników umożliwia bardzo precyzyjne wycięcie po obrysie wydrukowanej wcześniej grafiki, przy czym dołączone do plotera oprogramowanie umożliwia proste wykonanie projektu, wydruk na dowolnej drukarce i wycięcie grafiki. Wszystkie parametry plotera, to znaczy: siła nacisku noża, prędkość cięcia, punkt początkowy cięcia oraz test cięcia regulowane są z poziomu komputera. Sterowny przez port USB 2.0 współpracuje zarówno z Windows jak i MacOS.
 
Ploter wycina w:
- folia flex, flock (naprasowanki na koszulki, torby i inne tekstylia)
- folia samoprzylepna
- folia magnetyczna o grubości mniejszej niż 0,8mm (magnesy)
- folia szablonowa (maski, szablony malarskie)
- papier do 300g (zaproszenia, winietki, napisy okolicznościowe)
- karton
- cienki silikon do stempli
- foamiran i pianki kreatywne
- specjalne materiały typu papier naklejkowy, papier do tatuaży, papier fotograficzny, welin, folia termokurczliwa
 
Najważniejsze cechy PORTRAIT:
- cięcie w różnych materiałach
- szkicowanie mazakami
- cięcie materiałów podkładowych bez użycia maty, do 3m długości
- wycinanie wydruków według znaczników
- możliwość używania ostrza głęboko tnącego (Kraft do 2mm)
- cięcie pop-out (papieru/kartonu bez użycia maty, perforowane na wylot)
- grawerowanie
- wycinanie napisów i liter z wszystkich czcionek zainstalowanych na komputerze
- łączność Bluetooth
- nowy uchwyt na ostrze automatyczne (automatycznie dostosowuje głębokość ostrza zgodnie z ustawieniami w Silhouette Studio)
- funkcja automatycznego wykrywania narzędzi (z tyłu ostrza automatycznego i adapterów do narzędzi znajduje się mały metalowy pasek, który pokrywa się z ukrytym czytnikiem uchwytu na narzędzia Portrait 3, kiedy Portrait 3 jest włączony i podłączony do komputera, oprogramowanie Silhouette Studio sczytuje pasek i automatycznie uzupełnia wstawione narzędzie).
- siła nacisku do 210 gf, co pozwala na wycinanie w papierze o gramaturze ok 300g
- wymiary: – Ploter: 41,1 cm x 14,0 cm x 11,2 cm
– Mata: 20,3 cm x 30,48 cm (A4)
 
Wymagania sprzętowe:
- Wymagania do działanie oprogramowania Silhouette Studio:
- System operacyjny: PC (Windows 7, Windows 8, or Windows 10) lub Mac (OS X 10.6.8 i wyższe)(Chromebook jest nieobsługiwany).
- Połączenie internetowe: Zalecane (do wykonywania aktualizacji oprogramowanie Silhouette oraz rozszerzenia go do wersji Designer Edition).
- RAM: 1 GB RAM (2 GB zalecane).
- Procesor: 2 GHz (lub szybszy) szybkość pamięci procesora: 186 MB pamięci do programu (nie obejmują dodatkowej pamięci zalecanej do pobrania).
- USB Port: USB 1.1 Port (lub nowszy).
- Poprzez port USB2.0 PORTRAIT współpracuje zarówno z Windows jak i z MAC.
 
Standardowo ploter wyposażony jest w:
- zasilacz prądu stałego wraz z kablem zasilającym
- kabel USB
- uchwyt z nożem
- 50 wzorów w bibliotece online
- samoprzylepny arkusz transportowy
- instrukcja obsługi w języku polskim i angielskim
- sterowniki do Windows 98/ME/2000/XP/Vista/W7
- Program Silhouette Studio. Opcjonalnie Silhouette Studio Designer Edition umożliwiający między innymi współpracę z popularnymi programami graficznymi.
 
Oprogramowanie:
- w języku polskim
- darmowe
- duże możliwości projektowe, dzięki rozbudowanym narzędziom graficznym
- wycinanie napisów i liter z wszystkich czcionek zainstalowanych na komputerze
- 1 miesiąc darmowej subskrypcji w Silhouette Design Store (dostępny po rejestracji plotera)
- obsługuje formaty: GSD, DXF, PNG, JPG, BMP, GIF, TIFF
- możliwość rozszerzenia do wersji Designer czy wersji Business lub dokupienia wtyczki Connect z możliwością współpracy i wycinania plików z Corel oraz Addobe Illustrator.
