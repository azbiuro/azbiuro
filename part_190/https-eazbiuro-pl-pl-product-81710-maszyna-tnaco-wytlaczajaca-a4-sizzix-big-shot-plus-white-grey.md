---
title: "Maszyna tnąco - wytłaczająca A4 - | Wybierz w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/81710,maszyna-tnaco-wytlaczajaca-a4-sizzix-big-shot-plus-white-grey
lastmod: 
type: product
---
Maszyna tnąco - wytłaczająca A4 - | Wybierz w A-Z Biuro!
...
Maszyna tnąco - wytłaczająca A4 - sizzix big shot plus (white & grey)
...
Żdp-maszyna tnąco - wytłaczająca A4 - sizzix big s dostępny w eazbiuro.pl! | Zamów od ręki
...
- Maszyna tnąco - wytłaczająca Big Shot Plus jest wspaniałym narzędziem wprowadzającym do poznania technik nowoczesnego wycinania oraz wytłaczania
...
- Wielkość: A4
- Zestaw zawiera:  Maszynę Big Shot Plus, platformę bazową, standardową parę przezroczystych płytek do wycinania - Cutting Pads., adapter A, adapter B, ulotkę z opisem produktu, instrukcją użytkowania i procedurą reklamacyjną w j. polskim
- Wykorzystując wykrojniki typu Bigz, Movers & Shapers, Originals i On The Edge można wycinać kształty w papierze, tekturze, tkaninie, skórze, filcu i wielu innych grubszych materiałach. Wykrojniki Sizzlits, Framelits, Thinlits, Embosslits tną papier i cienki brystol, a foldery do embossingu wytłaczają w papierze, cienkim brystolu, a nawet w grubszej folii aluminiowej lub bardzo cienkiej blasze.
- Z pomocą maszyny Big Shot Plus oraz wykrojników i folderów do embossingu masz szansę tworzyć niepowtarzalne projekty kreatywne od scrapbookingu i własnoręcznego tworzenia kartek
- okolicznościowych, poprzez tworzenie wyjątkowych dekoracji, jak również projektów szytych (np. patchwork), biżuteryjnych czy tworzonych w technikach mieszanych. 
- Platforma bazowa, para standardowych płytek Cutting Pads oraz Adaptery A i B pozwalają na użycie dowolnej technologii Sizzix®.
- Za pomocą maszyny Big Shot Plus możesz wycinać i wytłaczać wykorzystując wykrojniki i foldery o różnej grubości. 
- Maszyna pozwala wycinać kształty o maksymalnej szerokości 20.3 cm i długości 27.9 cm.
- Bezpieczna i łatwa w użyciu, ergonomiczna rączka sprawia, ze praca z maszyną jest niezwykle komfortowa i nie wymaga użycia dużego nacisku (siły).
