---
title: "Maszyna tnąco-wytłaczająca sizzix | Zrób zakupy bez wysiłku!"
url: https://eazbiuro.pl/pl/product/81715,maszyna-tnaco-wytlaczajaca-sizzix-big-shot-pro
lastmod: 
type: product
---
Maszyna tnąco-wytłaczająca sizzix | Zrób zakupy bez wysiłku!
...
Maszyna tnąco-wytłaczająca sizzix big shot pro
...
Żdp-maszyna tnąco-wytłaczająca sizzix big shot pro dostępny w eazbiuro.pl! | Kup w okazyjnej cenie
...
- Big Shot Pro w nowej, zmienionej, szaro-białej obudowie to spełnienie marzeń każdego craftera, który w jednym urządzeniu szuka różnorodności funkcji i mnogości możliwości twórczych
- Maszyna została wzmocniona, by z siłą właściwą przemysłowym urządzeniom ciąć i tłoczyć różnego typu materiały przy użyciu wszystkich dostępnych w naszej ofercie wykrojników i szablonów
- To wszechstronne urządzenie współpracuje z większością wykrojników innych marek (w tym SureCut)
- Big Shot Pro to niemal nieograniczone możliwości tworzenia unikatowych kartek, zaproszeń, albumów, dekoracji domowych, kolaży, patchworków i wielu innych prac
- Maszyna posiada okno o szerokości 33 cm, które wycina i wytłacza różnego typu materiały jak np. papier, tektura, filc, pianka, tkanina, cienka płytka aluminiowa, płytka pleksi, skóra 
- Standardowy podajnik przesuwny jest przystosowany do pracy z wykrojnikami i folderami o maksymalnych wymiarach ok. 30,5x35,5 cm oraz mniejszymi, kompatybilnymi z Big Shot Pro
- Aby wykonać tzw. „kanapkę”, czyli składaną konstrukcję z płytek i materiału bazowego, może być konieczne użycie dodatkowych platform i adapterów
- Do pełnej zgodności maszyny z podłużnymi, stalowymi matrycami o wymiarze 63,5 cm wymagane jest zastosowanie niestandardowych, powiększonych akcesoriów, które nie wchodzą w skład zestawu: podajnika przesuwnego (Extended Sliding Tray), adaptera (Extended Adapter Pad) i podkładki tnącej (Extended Cutting Pads) 
- Wykrojniki cieńsze, niż Bigz Die wymagają zastosowania dodatkowej, niezałączonej do zestawu platformy do cienkich wykrojników Big Shot Solo Platform oraz adaptera z płytką i podkładką ustalającą do cienkich matryc Shim & Wafer-Thin Die Adapter. 
- Dzięki czytelnemu schematowi, wskazującemu krok po kroku, jak z płytek i materiałów wykonać nazywaną „kanapką”, prawidłową konstrukcję Sizzix, którą trzeba później przecisnąć przez rolki maszyny, użytkownik z łatwością i z sukcesem wykona kolejne etapy prac
- Zawartość zestawu:
- 1 maszyna Big Shot Pro 
- 1 standardowy podajnik przesuwny Standard Sliding Tray
- 1 standardowa płytka tnąca Standard Cutting Pad
- 1 dodatkowa płytka fałdująca Premium Crease Pad
- 2 podkładki z folii poliestrowej Mylar Shims o grubości 0,10 mm
- 1 standardowa podkładka adaptacyjna Standard Adapter Pad
- 1 szpikulec do wykrojników Die Pick
- Wymiary maszyny: 61,2 cm x 38 cm x 19,05 cm
- Waga brutto: ok 19,96 kg
- Maszyna jest wyposażona w odporną na zarysowania obudowę polimerową
- Okres gwarancji: 1 rok z możliwościa przedłużenia na kolejne 2 lata (Przed rozpoczęciem użytkowania urządzenia, zawsze należy upewnić się co do zgodności używanych akcesoriów z wymaganiami technicznymi maszyny) 
