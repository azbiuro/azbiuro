---
title: "Verbatim v3 usb 3.0 64gb store n | Wybierz jakość A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/93472,verbatim-v3-usb-3-0-64gb-store-n-go-drive-grey-49174
lastmod: 
type: product
---
Verbatim v3 usb 3.0 64gb store n | Wybierz jakość A-Z Biuro!
...
Verbatim v3 usb 3.0 64gb store n go drive grey 49174
...
Verbatim v3 usb 3.0 64gb store n go drive grey 4 dostępny w eazbiuro.pl! | Kup ekspresowo

Opis produktu

Dzięki interfejsowi USB 3.0 zapewniającemu niezwykle szybkie przesyłanie danych napęd Store 'n' Go V3 USB jest do 10 razy szybszy od napędów korzystających z interfejsu USB 2.0*. Pozwala to na znaczne przyspieszenie zapisywania dużych plików dowolnego rodzaju.

Mechanizm 'slide and lock' pozwala chronić złącze USB napędu V3 USB. Podczas korzystania z napędu złącze jest wysunięte, a po zakończeniu pracy można je schować i zablokować wewnątrz urządzenia.

Napęd jest niezwykle prosty i wygodny w obsłudze: wystarczy podłączyć go do dowolnego portu USB 3.0 (dostępna jest obsługa portów 2.0), a następnie skopiować wybrane foldery oraz pliki metodą „przeciągnij i upuść”.

* W oparciu o teoretyczną wydajność magistrali USB 3.0 wynoszącą. Rzeczywista wydajność zależy od rozmiaru pliku i parametrów komputera.

Szczegóły produktu
Pojemność: 64 GB
Prędkość odczytu: do 60 MB/s (system hosta USB 3.0)
Prędkość zapisu: do 12 MB/s (system hosta USB 3.0)

Interfejs USB 3.0 SuperSpeed.
Chowane złącze 'slide and lock' zabezpiecza złącze USB.
Kompaktowy i elegancki.

Wymagania systemowe
Porty USB 3.0/USB 2.0
Windows 10, 8, 7, XP
...
Dane techniczne
Waga produktu: 10 g
Wymiary produktu: 58 mm x 20 mm x 11 mm (D x S x W)
Przechowywanie danych: 10 lat
Źródło zasilania: Magistrala USB (nie trzeba stosować baterii)
Interfejs: USB 3.0 — zgodność ze standardem USB 2.0
Format: FAT32
