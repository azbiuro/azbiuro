---
title: "Folder recycle A4 pp 140 mic. | Sprawdź i zamów w A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/65535,folder-recycle-a4-pp-140-mic-opakowanie-100-sztuk
lastmod: 
type: product
---
Folder recycle A4 pp 140 mic. | Sprawdź i zamów w A-Z Biuro!
...
Folder recycle A4 pp 140 mic. opakowanie 100 sztuk
...
Folder recycle A4 pp 140 mic. opakowanie 100 szt dostępny w eazbiuro.pl! | Chwyć ekspresowo
...
- Folder A4 Leitz Recycle Przyciągający wzrok, najwyższej jakości folder wytworzony z materiałów pochodzących z recyklingu do łatwego przechowywania i odczytu dokumentów
- Wykonany w 90% z plastiku pochodzącego z recyklingu (który przeszedł zewnętrzny audyt UL, tym samym otrzymując certyfikat UL), neutralny dla klimatu, w 100% nadający się do recyklingu
- To solidny i praktyczny folder, który doskonale uzupełnia inne produkty z gamy Leitz Recycle
- Nowoczesne artykuły biurowe, które świetnie będą prezentować się w domu i biurze
- Dzięki nowej, przyjaznej dla środowiska linii produktów Recycle firmy Leitz możesz poprawić zarówno środowisko biurowe, jak i środowisko naszej planety
- Wysokiej jakości folder wytworzony z materiałów pochodzących z recyklingu, odpowiednia na format A4, zawiera 100 sztuk w pudełku
- Plastik pochodzący z recyklingu, neutralny dla klimatu i w 100% nadający się do recyklingu
- Wykonany w 90% z przetworzonego plastiku (który przeszedł zewnętrzny audyt UL tym samym otrzymując certyfikat UL) i w 100% nadającego się do recyklingu, neutralnego dla klimatu
- Folder A4 do przenoszenia, zabezpieczania i prezentacji dokumentów z łatwym dostępem do zawartości dzięki otwieraniu z góry i z prawej strony
- Trwałe, najwyższej jakości i nietoksyczne tworzywo sztuczne (PP) gwarantuje możliwość wielokrotnego użytku
- Idealny do organizowania dokumentów podczas podróży, ponieważ zajmuje niewiele miejsca i można go łatwo włożyć do torby na laptopa lub plecaka
- Matowa powierzchnia z najwyższej jakości folią o grubości 140 mikronów
- Folia copy safe zapobiega migracji atramentu z papieru na plastik
- Bezkwasowy materiał zapobiega żółknięciu papieru z upływem czasu i jest idealny do długotrwałej archiwizacji ważnych dokumentów
- Wyprodukowano w Europie
- Opakowanie bez plastiku z pudełkiem kartonowym pochodzącym w 100% z recyklingu, w pełni nadaje się do recyklingu
