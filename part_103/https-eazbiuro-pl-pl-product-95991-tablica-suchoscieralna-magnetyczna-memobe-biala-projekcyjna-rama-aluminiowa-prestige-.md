...
url: https://eazbiuro.pl/pl/product/95991,tablica-suchoscieralna-magnetyczna-memobe-biala-projekcyjna-rama-aluminiowa-prestige-100-220x139-cm
lastmod: 
type: product
---
...
Tablica suchościeralna magnetyczna Memobe, biała, projekcyjna, rama aluminiowa prestige, 100", 220x139 cm
...
Tablica suchościeralna magnetyczna Memobe, biała dostępny w eazbiuro.pl! | Złap z szybkim odbiorem

Opis produktu
Tablica projekcyjna 100" MemoBe.Dzięki zastosowaniu matowej powierzchni znakomicie sprawdza się jako ekran projekcyjny do rzutników multimedialnych. Powierzchnia z wysokiej jakości stali pokrytej starannie lakierem w kolorze białym. Tablica wykazuje właściwości magnetyczne, które pozwalają na zawieszanie grafik i kartek za pomocą magnesów oraz właściwości suchościeralne, które dają możliwość pisania po jej powierzchni dedykowanymi markerami suchościeralnymi lub kredowymi. Rama Prestige wykonana z anodowanego aluminium o szer. 20 mm i grub. 18 mm. Narożniki w kolorze popielatym. Na rewersie tablicy poza pilśnią zastosowano jako dodatkowe wzmocnienie blachę ocynkowaną, która zapewnia stabilność i sztywność tablicy oraz chroni ją przed wilgocią.Montaż tablicy w pionie lub poziomie w czterech rogach. W zestawie półka na markery, suchościeralny marker, komplet wkrętów i kołów rozporowych do montażu tablicy na ścianie oraz instrukcja montażu. Półka wykonana z aluminium anodowanego o dług. 30 cm. Produkt do użytku wewnętrznego.Tablica przede wszystkim służy jako ekran projekcyjny. Dzięki specjalnej, półmatowej tablice projekcyjne zapewniają bardzo dobry kontrast prezentowanych treści. Ze względu na zastosowanie półmatowej powierzchni wymagane jest częstsze stosowanie płynów do czyszczenia tablic (czym wyższa matowość powierzchni, tym niższa ścieralność markera).Tablice projekcyjne doskonale sprawdzają się zarówno w salach konferencyjnych, lekcyjnych jak i w aulach wykładowych. Stanowią znakomite wsparcie dla liderów spotkań biznesowych oraz nauczycieli, którzy mogą wzbogacać swoje prezentacje i wykłady o komunikaty wizualne, co z kolei wpływa na ich szybkie zapamiętywanie. Dzięki wysokiej jakości powierzchni, prezentowane na tablicy treści są dobrze widoczne – nawet z dalszej części sali. Okres gwarancji na powierzchnię 10 lat.Tablice projekcyjne MemoBe posiadają Certyfikat Zgodności, który potwierdza, że wyrób spełnia wymagania zawarte w normie PN-EN 14434:2010, tzn. jest bezpieczny podczas jego montażu i użytkowania. Produkt opatrzony jest znakiem B (Bezpieczeństwo).
