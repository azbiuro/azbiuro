---
title: "Ołówek castell 9000 jumbo | Zamów w najlepszej cenie!"
url: https://eazbiuro.pl/pl/product/96732,olowek-castell-9000-jumbo-blister-5-szt-faber-castell
lastmod: 
type: product
---
Ołówek castell 9000 jumbo | Zamów w najlepszej cenie!
...
Ołówek castell 9000 jumbo blister 5 szt. Faber-Castell
...
Ołówek castell 9000 jumbo blister 5 szt. Faber-C dostępny w eazbiuro.pl! | Skorzystaj już teraz

Opis produktu
Najwyższej jakości artystyczny, grafitowy ołówek, który nadaje się do profesjonalnego użytku między innymi dla artystów, projektantów, architektów, grafików i innych. Ołówek został wytworzony z wysokiej jakości miękkiego drewna, które gwarantuje użytkownikowi łatwe temperowanie. Dodatkowo dzięki specjalnej technologii klejenia (SV) łamliwość grafitu jest ograniczona nawet podczas upadku. Powierzchnia ołówka pokryta jest lakierem na bazie wody, który nie szkodzi środowisku oraz jest bezpieczny dla użytkownika. Produkt dostępny jest w 5 stopniach twardości (HB, 2B, 4B, 6B, 8B), które zapewniają zróżnicowane odcienie szarości.
