---
title: "Zestaw Marvo cm409 en, | Skorzystaj z okazji teraz!"
url: https://eazbiuro.pl/pl/product/88028,zestaw-marvo-cm409-en-klawiatura-mysz-podkladka-sluchawki-us-do-gry-membranowa-przewodowa-usb-czarna
lastmod: 
type: product
---
Zestaw Marvo cm409 en, | Skorzystaj z okazji teraz!
...
Zestaw Marvo cm409 en, klawiatura+mysz+podkładka+słuchawki, us, do gry, membranowa, przewodowa (usb), czarna
...
Zestaw Marvo cm409 en, klawiatura+mysz+podkładka dostępny w eazbiuro.pl! | Dodaj do koszyka na ostatnią chwilę
...
- CM409 EN to gotowy zestaw przeznaczony dla początkujących graczy
- W zestawie użytkownik otrzymuje funkcjonalną i trwałą klawiaturę membranową, której żywotność klawiszy wynosi aż 10 mln uderzeń
- Wykończenie klawiatury to efektowne wielokolorowe podświetlenie LED (zarówno liter jak i całych klawiszy)
- Ergonomiczny kształt oraz wysoki skok przycisków zapewnią graczom niepowtarzalne wrażenia podczas ulubionych sesji gamingowych
- Siła nacisku klawiszy 55+/-7g odpowiada klawiaturze mechanicznej wyposażonej w przełączniki BLUE
- Klawiatura podłączana jest do komputera za pomocą przewodu USB o długości 1,5 m
- Mysz Marvo została wyposażona w precyzyjny sensor optyczny o regulowanej maksymalnej rozdzielczości 800-1600- 2400-3200 DPI, które można zmieniać w czasie gry za pomocą centralnie umieszczonego przycisku DPI Switch
- 6 przycisków myszy pozwala na ustawienie dodatkowych skrótów niezbędnych w trakcie gry
- Klawisze oddają odgłos delikatnego kliknięcia, wraz z wyczuwalnym skokiem gracz ma zawsze pewność i kontrolę nad wykonanym działania lub oddanym strzałem w trakcie gry
- Mysz podobnie jak klawiatura posiada wielokolorowe podświetlenie Rainbow LED, które nadaje jej odpowiedniego charakteru oraz sprawia, że idealnie komponuje się z klawiaturą
- Kolejnym elementem zestawu Marvo CM409 EN są słuchawki z jakością dźwięku stereo
- Słuchawki posiadają obustronną regulację rozstawu pałąka, dzięki czemu idealnie dopasowują się do kształtu głowy  - Poduszki uszne oraz pałąk zostały wyścielone miękkim, skóropodobnym materiałem i wypełnione gabką
- Poduszki dobrze izolują dźwięki z otoczenia co znakomicie poprawia koncentrację w trakcie rozgrywki
- Doskonała jakość dźwięku wspaniale sprawdzi się w czasie grania, oglądania filmów czy słuchania muzyki
- Ostatnim elementem zestawu Marvo CM370 jest podkładka wykonana z wysokiej jakości materiału, który zapewnia wysoką precyzję śledzenia ruchów myszy, oraz redukuje tarcie myszki o powierzchnię
- Podkładka bezproblemowo współpracuje zarówno z myszkami laserowymi, jak i optycznymi
- SPECYFIKACJA KLAWIATURY:
- Liczba klawiszy: 104
- Żywotność klucza: do 10 mln. kliknięć
- Głębokość kompresji: 4,0 ± 0,3 mm
- Siła nacisku: 55 ± 7 g 7
- Podświetlenie: Rainbow LED
- Połączenie: USB 2.0
- Długość kabla: 1,5 m
- Wymiary: 435 x 128 x 35 mm
- SPECYFIKACJA MYSZY:
- Czujnik: optyczny
- DPI: 800/1600/2400/3200
- Liczba przycisków: 6
- Żywotność przycisku: 3 mln. kliknięcia
...
- Połączenie: złącze 2 x 3,5 mm
- Długość kabla: 1,8 m
- SPECYFIKACJA PODKŁADKI
- Optymalna współpraca z sensorami laserowymi i optycznymi
- Powłoka odporna na pot
- Gumowany antypoślizgowy spód
