---
title: "Zestaw Marvo cm306, klawiatura + | Wybierz tanio i wygodnie!"
url: https://eazbiuro.pl/pl/product/87962,zestaw-marvo-cm306-klawiatura-mysz-podkladka-dla-graczy-us-do-gry-membranowa-przewodowa-usb-czarna-podswietlona
lastmod: 
type: product
---
Zestaw Marvo cm306, klawiatura + | Wybierz tanio i wygodnie!
...
Zestaw Marvo cm306, klawiatura + mysz + podkładka DLa graczy, us, do gry, membranowa, przewodowa (usb), czarna, podświetlona
...
Zestaw Marvo cm306, klawiatura + mysz + podkładk dostępny w eazbiuro.pl! | Dodaj do koszyka w niskiej cenie
...
- Podstawą zestawu jest pełnowymiarowa membranowa klawiatura multimedialna
- Klawisze funkcyjne posiadają zaprogramowane funkcje multimedialne oraz klawisz F12 z szybkim wywołaniem kalkulatora
- W lewej części klawiatury 3 dodatkowe klawisze z odnośnikami Mój komputer, Przeglądarka internetowa, Mail
- Dla graczy istotnym elementem pozostaje klawisz Win lock
- Sam kształt klawiszy z lekkim ugięciem pozwala na lepsze ułożenia palców ograniczając możliwość ześlizgnięcia w czasie gry
- Klawiatura posiada podświetlenie Rainbow LED
- Żywotność klawiszy oszacowana jest na 10 milionów kliknięć
- Na atrakcyjny design klawiatury wpływ mają charakterystyczne mocno akcentowane linie i niewielka podkładka pod nadgarstek
- 2 nóżki pozwalają nieco podnieść tył klawiatury, a gumowe podkładki ograniczają przesuwanie po blacie biurka
- Mysz CM306 została bardzo ładnie wykonana, o ciekawym wyglądzie, którego charakterystycznym elementem są podświetlane LED-owo linie
- Mysz posiada zaprogramowane 4 tryby podświetlenia
- Dedykowane do myszy oprogramowanie pozwala użytkownikom na konfigurację 7 przycisków
- Dla ułatwienia konfiguracji poszczególne przyciski posiadają już wstępnie zaprogramowane najpopularniejsze funkcje
- Miłą niespodzianką są wcześniej zaprogramowane klawisze do gry PUBG
- Użytkownik może również samodzielnie zaprogramować własne makro do swojej ulubionej gry
- Dla bardziej zaawansowanych użytkowników oprogramowanie umożliwia ustawienie szybkości sensora, scroll czy raportowania od 125 do 1000 Hz
- Stopniowa regulacja w jednostkach co 200 DPI  umożliwia ustawienie 4 poziomów w zakresie od 200 do 4800 DPI
- Ostatnim zestawy elementem jest podkładka z charakterystycznym znakiem żądła skorpiona i logiem Marvo - Gumowane podłoże utrzymuje stabilnie podkładkę w trakcie gry, piankowa baza i górna powłoka gwarantują bardzo dobre prowadzenie myszy i działanie sensora
- Obszar roboczy podkładki wynosi 23 x 26 cm
- SPECYFIKACJA KLAWIATURY:
- Liczba klawiszy: 107
- Typ: membranowy
- Żywotność klawiszy: 10 mln kliknięć
- Siła nacisku klawisza: 55g +/- 10g
- Skok klawisza 4 mm +/- 0,3mm
- Podświetlenie: Raindow LED
- Wymiary klawiatury 43,5 x 20 cm
- Długość przewodu: 1,5m
- SPECYFIKACJA MYSZY:
- Liczba klawiszy: 7 (programowalne)
- Podświetlenie: Rainbow LED (4 tryby)
- Żywotność klawiszy: 5 mln kliknięć
- Rozdzielczość sensora: 1200-4800 DPI standard
- Rozdzielczość sensora: 200-4800 DPI po zaprogramowaniu
- Raportowanie sensora: od 125 do 1000 Hz
- Dodatkowe funkcje: Zaprogramowane makro do gry PUBG
- Wymiary: 127 x 70 x 40 mm
