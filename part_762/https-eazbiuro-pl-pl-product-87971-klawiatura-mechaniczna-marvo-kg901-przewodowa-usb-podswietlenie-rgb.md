---
title: "Klawiatura mecHaniczna Marvo | Odbierz w najlepszej cenie!"
url: https://eazbiuro.pl/pl/product/87971,klawiatura-mechaniczna-marvo-kg901-przewodowa-usb-podswietlenie-rgb
lastmod: 
type: product
---
Klawiatura mecHaniczna Marvo | Odbierz w najlepszej cenie!
...
Klawiatura mecHaniczna Marvo kg901, przewodowa (usb), podświetlenie rgb
...
Marvo kg901, klawiatura us, do gry, niebieskie p dostępny w eazbiuro.pl! | Kup i oszczędzaj
...
- Klawiatura mechaniczna Marvo KG901 to świetny wybór dla profesjonalnych graczy 
- Stanowi odpowiedź dla tych, którzy nie chcą iść na kompromis oczekując w zamian maksymalnej precyzji, szybkości, wszechstronności, reakcji i trwałości
- KG901 z powodzeniem łączy najważniejsze funkcje konkurencyjnej klawiatury w super kompaktowej obudowie dostępnej dla każdego wymagającego gracza
- Eliminacja 17 klawiszy i wykorzystanie układu składającego się tylko z 87 klawiszy przekłada się na zajęcie mniejszej o 30% ilości miejsca w porównaniu do klasycznej klawiatury
- Technologia NKRO pozwala na naciśnięcie wszystkich klawiszy bez powodowania blokady klawiatury
- System oświetlenia Rainbow jest konfigurowalny i wykorzystuje oddzielne dla każdego przycisku diody LED
- Zaawansowane funkcje bez sterownika
- Klawiatura Marvo KG901 umożliwia wybór wielu schematów oświetlenia, konfigurację profili oświetlenia dla ulubionych gier, a także dostęp do kontrolek multimedialnych
- Oczywiście nie mogło zabraknąć opcji tymczasowego wyłączenia klawisza Windows, eliminując tym samym możliwość przypadkowego naciśnięcia go w trakcie gry
- KG901 ma elegancką, czarną, bezramową obudowę z matowym wykończeniem Klawisze są podniesione i można je wyjąć w celu łatwego czyszczenia. 
- Stabilność i trwałość są zapewnione dzięki zastosowaniu wyjątkowo wytrzymałej plastikowej ramy oraz przełączników o żywotności ok. 50 milionów wciśnięć
- Liczba klawiszy 87
- Typ przełącznika: Mechaniczny (Blue) 
- Skok klawiszy 3,8 ± 0,4 mm
- Siła nacisku: 60 ± 10 g
- Podświetlenie: Rainbow (6-kolorowe)
- Interfejs: USB 2.0
- Długość kabla: 1,6 m
- Obsługa systemu operacyjnego: Windows 7 lub nowszy
- Kompaktowa konstrukcja z wąską ramą i układem TKL (tenkeyless)
- Ponad 20 schematów oświetlenia do wyboru
- Pięć klawiszy makr programowalnych bez sterownika (nr 1 do nr 5)
- Wytrzymała konstrukcja: metalowa płyta przednia i wysokiej jakości ABS
