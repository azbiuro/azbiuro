---
title: "Ploter tnący kreatywny | Wybierz tanio i wygodnie!"
url: https://eazbiuro.pl/pl/product/81677,ploter-tnacy-kreatywny-silhouette-cameo-4
lastmod: 
type: product
---
Ploter tnący kreatywny | Wybierz tanio i wygodnie!
...
Ploter tnący kreatywny silhouette cameo 4
...
Żdp-ploter tnący kreatywny silhouette cameo 4 dostępny w eazbiuro.pl! | Odbierz z gwarancją jakości
...
- SILHOUETTE CAMEO 4 to najnowszy ploter fimy Silhouette
- To nowy, ulepszony model plotera Silhouette Cameo 3
- Z jego pomocą stworzysz samodzielnie dekoracje 3D, pudełka, duże naklejki, albumy, boxy, kartki okolicznościowe, przyozdobisz tkaninę, szkło i drewno oraz wiele innych
- Cameo 4 zapewnia olbrzymie możliwości projektowe dzięki rozbudowanym narzędziom graficznym. Oprogramowanie do plotera jest w języku polskim i co najważniejsze – darmowe
- Dzięki niemu możliwe jest wycinanie wszystkich czcionek zainstalowanych na komputerze
- Cameo 4 wyposażony został w profesjonalny mechanizm cięcia – wytniemy nim dowolny wzór na papierze, filcu, folii i tkaninie
- To jedyny model, który posiada wbudowany podajnik do folii co umożliwia regulacje szerokości rolki oraz trymer, który ułatwia oddzielenie wzoru od rolki
- Jego budowa pozwala na wycinanie w materiałach podkładowych bez użycia maty, co zmniejsza koszty eksploatacyjne i powiększa pole pracy do 3m długości
- Cameo 4 w porównaniu ze swym poprzednikiem (Cameo 3) jest 3 razy szybszy, a zwiększenie siły nacisku do 5 kg (221g w Cameo 3), pozwala na wycinanie w bardzo grubych materiałach (skóra, balsa, pianka itp.)
- Silhouette Cameo 4 sprawdzi się zarówno do użytku domowego, jak i w profesjonalnych firmach
- Najważniejsze cechy (ulepszenia) plotera tnącego Cameo 4 to: 3 - krotnie większa prędkość niż poprzedni model – Cameo 3, panel dotykowy, wykrywanie włożonego narzędzia, system motoryczny podwójny, aż 5 kg nacisku – dla porównania ploter Cricut Maker – 4 kg, Cameo 3 – 221 gram, wbudowany podajnik do folii, wbudowany trymer do folii, ostrze automatyczne regulujące się tylko jednym kliknięciem, nowy system przesuwania prowadnic na rolkach plotera
- Dzięki zastosowanym ulepszeniom w ploterze tym można korzystać z obrotowego ostrza i ostrza kraft, które umożliwiają cięcie tkanin, balsy, skóry, pianki oraz grubszych materiałów
- Dodatkowe akcesoria dostępne oddzielnie: ostrze Kraft do grubych materiałów, punch Tool do dziurkowania, rotary Blade ostrze obrotowe do cięcia tkanin
- Do plotera Cameo 4 powstał nowy zestaw narzędzi, który nie jest kompatybilny ze starszymi modelami. Natomiast ostrza stosowane w poprzednich modelach, dzięki dołączonym do plotera adapterom, są kompatybilne z Cameo 4
- Ploter wycina w: cienkie materiały, cienki filc wysokiej jakości, cienki silikon do stempli, papier wysokiej jakości do 300g, folie samoprzylepne (scrapbooking, naklejki na ścianę, drewno, szkło), folie flex i flock (naprasowanki na koszulki, torby, tekstylia), folie magnetyczne, folie do masek, szablonów malarskich, oraz dżetów i cyrkonii, pianka kreatywna
- Dodatkowe ostrze obrotowe (Rotary Blade) umożliwia wycinanie w: filc, skóra, grubsze materiały, dzianiny, tkaniny
- Podstawowe funkcje plotera: możliwość grawerowania,  możliwość używania ostrza do cięcia w materiałach o grubości do 3mm, możliwość wycinani w materiale, papierze, folii, wycinanie wydruków – funkcja print and cut, szkicowanie mazakami, cięcie materiałów podkładowych bez użycia maty, do 3 m długości, łączność Bluetooth, możliwość projektowania dzięki dołączonemu oprogramowaniu Silhouette Studio w języku polskim
- W zestawie znajduję się: ploter Silhouette Cameo 4, mata o wymiarach 12×12 cali (30x30cm), ostrze automatyczne Cameo 4, 4 adaptery do akcesoriów, kabel zasilający, kabel usb, oprogramowanie Silhouette Studio, 100 wzorów w programie Silhouette Studio, miesięczny bon o wartości 25 $ do wykorzystania w Silhouette Design Studio na pobranie dodatkowych projektów, instrukcja, poradnik 
