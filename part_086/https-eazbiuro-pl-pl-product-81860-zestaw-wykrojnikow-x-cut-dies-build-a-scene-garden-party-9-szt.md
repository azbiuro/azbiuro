---
title: "Zestaw wykrojników - x-cut dies | Dodaj do zamówienia teraz!"
url: https://eazbiuro.pl/pl/product/81860,zestaw-wykrojnikow-x-cut-dies-build-a-scene-garden-party-9-szt
lastmod: 
type: product
---
Zestaw wykrojników - x-cut dies | Dodaj do zamówienia teraz!
...
Zestaw wykrojników - x-cut dies - build a scene - garden party, 9 szt.
...
Żdp-zestaw wykrojników - x-cut dies - build a scen dostępny w eazbiuro.pl! | Sprawdź i oszczędzaj
...
- Zestaw wysokiej jakości wykrojników, pasujących do większości dostępnych na rynku maszyn wycinających
- Wzory specjalnie zaprojektowano do tworzenia warstwowych scenek i dekoracji, co pozwoli stworzyć wiele wspaniałych projektów, kartek okolicznościowych lub ozdób do dekoracji domu
- Wykrojniki wycinają w papierze do grubości 250 g/m2 oraz piance (do 2 mm)
- Zestaw zawiera: 9 wykrojników w różnych kształtach i rozmiarach, matę magnetyczną ułatwiająca przechowywanie
- Produkt nieodpowiedni dla dzieci poniżej 3 lat
- Do użytku przez dzieci wyłącznie pod nadzorem osoby dorosłej.
