---
title: "Folia termokurczliwa shrink | Zrób wygodne zakupy online!"
url: https://eazbiuro.pl/pl/product/81668,folia-termokurczliwa-shrink-poltransparentna-6-sztuk
lastmod: 
type: product
---
Folia termokurczliwa shrink | Zrób wygodne zakupy online!
...
Folia termokurczliwa shrink półtransparentna, 6 sztuk
...
Żdp-folia termokurczliwa shrink półtransparentna dostępny w eazbiuro.pl! | Odbierz w limitowanej ofercie
...
- Folia termokurczliwa to doskonała baza do tworzenia oryginalnych elementów i dodatków, które mogą zostać wykorzystane w projektach typu cardmaking, scrapbooking, home decor, do tworzenia biżuterii, dodatków fashion (przypinek, zawieszek, breloczków, itp.) i wielu innych
- Dzięki folii możesz stworzyć dowolne wzory, we wszystkich kolorach
- Kolor: półtransparentny
- Grubość: 0,3 mm
- Format: arkusz A4
- Ilość arkuszy w opakowaniu: 6 sztuk
- Produkt jest nietoksyczny
 
Jak to zrobić?
- Folie kolorowe są z jednej strony matowe a z drugiej błyszczące
- Przeszlifuj delikatnie matową stronę folii drobnoziarnistym papierem ściernym – dzięki temu zwiększysz przyczepność tuszów, farb, pisaków, kredek, mgiełek, itp
- Odbij wybrany stempel lub narysuj swój własny projekt
- Wytnij nożyczkami przygotowany wzór
- Do wycinania kształtów możesz też użyć wykrojników lub dziurkaczy
- Tak przygotowany element umieść na papierze do pieczenia i włóż do piekarnika na 3 minuty (piekarnik nagrzany do 140-160 stopni) lub użyj uniwersalnej nagrzewnicy dpCraft
- Wykorzystując nagrzewnicę połóż element z folii na specjalnym podkładzie (coś co może się nagrzewać) i przytrzymaj element patyczkiem lub pęsetą
- W czasie nagrzewania element z folii zacznie się kurczyć i wywijać, a na końcu się rozprostuje
- Gotowe - po podgrzaniu folia twardnieje, wykonany element jest trwały
 
Wskazówki:
- Folia termokurczliwa, jak sama nazwa wskazuje, kurczy się, dlatego elementy po wygrzaniu są o ok. 60% mniejsze od pierwotnego wzoru
- Jeżeli przygotowany element chcesz wykorzystać jako zawieszka to przed wygrzaniem wykonaj w nim dziurkę np. przy pomocy dziurkacza punktowego lub dziurkacza „kombinerki”
- Pamiętaj, że otwór w gotowym elemencie również będzie mniejszy o ok. 60%
- Aby osiągnąć ładny, prosty wzór, po wyjęciu z piekarnika lub wygrzaniu nagrzewnicą przyciśnij gotowy element czymś płaskim (np. bloczkiem akrylowym lub dnem szklanki)
- Folię najlepiej zdobić permanentnymi pisakami, markerami lub tuszami
- Malując/kolorując wzór warto pamiętać, że w efekcie końcowym kolory będą znacznie intensywniejsze
