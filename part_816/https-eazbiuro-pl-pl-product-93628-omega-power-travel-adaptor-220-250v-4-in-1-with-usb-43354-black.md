---
title: "Omega power travel adaptor | Wybierz jakość A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/93628,omega-power-travel-adaptor-220-250v-4-in-1-with-usb-43354-black
lastmod: 
type: product
---
Omega power travel adaptor | Wybierz jakość A-Z Biuro!
...
Omega power travel adaptor 220-250v 4 in 1 with usb (43354) black
...
Omega power travel adaptor 220-250v 4 in 1 with dostępny w eazbiuro.pl! | Chwyć w promocyjnej cenie teraz

Opis produktu
OMEGA POWER TRAVEL ADAPTOR ORA1 - to unikalne urządzenie zapewniające komfort podróżowania ze sprzętem elektronicznym. W kompaktowym kształcie mieszczą się 4 wysokiej klasy adaptery pasują do gniazd elektrycznych praktycznie na całym świecie. W zależnosci od miejsca w którym aktualnie jesteś, korzystasz z wybranej funkcji adaptera (CN, UK, US, EU) aby podłączyć urządzenie do sieci elektrycznej w bardzo łatwy sposób. Urządzenie wyposażone jest w dwa gniazda USB (2A). Dodatkowo wbudowany moduł ochrony przeciw-przepięciowej zabezpiecza przed skokami nagłego wzrostu napięcia w sieci elektrycznej. 
 
Dzięki opatentowanemu rozwiązaniu, Omega Power Travel Adaptor jest wyjątkowo kompaktowa i łatwa w przenoszeniu. Niezależnie gdzie jesteś, czy w USA, UK, Chinach, czy Europie, możesz korzystać z jednego adaptera aby skorzystać z sieci elektrycznej. 
 
Specyfikacja: 
 
Wymiary: 75x48x40mm 
Waga: 95g 
UWAGA: Urządzenie nie konwertuje napięcia, przed podłączeniem do sieci proszę sprawdzić czy dostarczane napięcie jest obsługiwane przez urządzenie. Być może wymagana będzie dodatkowa modyfikacja ustawień napięcia urządzenia ze 110V na 230V, lub odwrotnie. 
