---
title: "Tabletki czyszczące do ekspersu | Wybierz jakość A-Z Biuro!"
url: https://eazbiuro.pl/pl/product/52652,tabletki-czyszczace-do-ekspersu-12-sztuk-4swiss
lastmod: 
type: product
---
Tabletki czyszczące do ekspersu | Wybierz jakość A-Z Biuro!
...
Tabletki czyszczące do ekspersu 12szt 4swiss dostępny w eazbiuro.pl! | Kup taniej niż zwykle
...
- Tabletki czyszczące 4Swiss 782 - to niezbędny detergent, który po wprowadzeniu rozpuszcza olejki kawowe (osad) znajdujące się na ściankach układu oraz modułu zaparzającego. Tabletki nadają się do wszystkich modeli ekspresów automatycznych marki 4Swiss.
- urządzenie wykorzystuje naturalne produkty do parzenia napojów (ziarna kawy, wodę, mleko itp.), na powierzchni elementów roboczych mogą być widoczne: osad po kawie i/lub ślady skroplonej pary wodnej. Z tego powodu zaleca się, aby okresowo czyścić zarówno widoczne części urządzenia jak i obszar pod nimi.
- Profesjonalna pielęgnacja i solidna konserwacja.
- Zapewniają optymalną jakość parzonej kawy.
- Gwarantują długą i bezawaryjną pracę ekspresu.
- Należy je stosować zgodnie z instrukcją ekspresu jaki się posiada !!
- Tabletki specjalnie dostosowane do automatycznych ekspresów do kawy firmy 4Swiss.
- W opakowaniu 12 szt 
