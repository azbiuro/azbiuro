---
title: "Pentel marker kredowy - końcówka ścięta | Dodaj do koszyka!"
url: https://eazbiuro.pl/pl/product/94365,pentel-marker-kredowy-koncowka-scieta-4-3mm-sm26-pro4mx1eu
lastmod: 
type: product
---
Pentel marker kredowy - końcówka ścięta | Dodaj do koszyka!
...
Pentel marker kredowy - końcówka ścięta 4,3mm sm26-pro4mx1eu
...
Pentel marker kredowy - końcówka ścięta 4,3mm sm dostępny w eazbiuro.pl! | Złap w super promocji

Opis produktu
Pentel Liquid Glass and Chalk Marker to marker do wycierania na mokro
do stosowania na każdej gładkiej i szczelnej powierzchni. Po
napompowaniu pisaka poprzez kilkukrotne przyciśnięcie końcówki do
powierzchni, płynny tusz znajdujący się w środku może być
używany do pisania na większości szklanych powierzchni i innych
gładkich powierzchniach, takich jak lustra lub tablice
ceramiczne. Po nałożeniu wysoko kryjący tusz na bazie wody daje
efekt podobny do płynnej kredy, co pozwala na tworzenie efektów
specjalnych przez użytkownika. 

Po wyschnięciu atrament jest odporny na warunki atmosferyczne na
szkle. Wet Erase to marker do tymczasowego znakowania, który można
usunąć bez pozostawiania śladów. Pentel Liquid Glass and Chalk
Marker ma dwa rodzaje końcówek. Obracając końcówkę możesz
uzyskać różna szerokość linii pisania. (Końcówka jest z jednej
strony ścięta a z drugiej okrągła).

Idealny do stosowania na szkle (np. w salonach samochodowych lub
usługach szklarskich), do ogłoszeń dla klientów i zastosowań
dekoracyjnych w handlu detalicznym (np. na witrynach sklepowych), w
hotelach i restauracjach (np. tablice menu) oraz w projektach domowych
(np. kreatywna prace na oknach lub przedmiotach szklanych).

WAŻNE: Marker może pozostawić trwałe ślady na powierzchniach,
które są porowate lub nie są w pełni gładkie. Należy pamiętać,
że na foliach tablicowych mogą pozostać resztki markera. Zawsze
najpierw przetestuj na niewidocznym obszarze.
