---
title: "Termobindownica GBC thermabind | Odbierz z szybką dostawą!"
url: https://eazbiuro.pl/pl/product/48799,termobindownica-gbc-thermabind-t400-bindowanie-400-kartek
lastmod: 
type: product
---
Termobindownica GBC thermabind | Odbierz z szybką dostawą!
...
Termobindownica GBC thermabind t400, bindowanie 400 kartek
...
Termobindownica GBC thermabind t400, bindowanie dostępny w eazbiuro.pl! | Dodaj do koszyka już teraz
...
- Przewodnik po rozmiarach okładek pomoże dobrać odpowiednią okładkę do bindowania termicznego
- Sygnały wizualne i dźwiękowe informują o zakończeniu cyklu bindowania
- Ogranicznik krawędzi pomaga utrzymać pozycję dokumentu i jest pomocny przy wielokrotnym bindowaniu, a zintegrowana półka przeznaczona jest do chłodzenia zbindowanych dokumentów i zapobiega ich pomieszaniu z dokumentami właśnie oprawianymi
- Binduje do 400 kartek (80 gms) przy zastosowaniu grzbietów 40 mm
- Wyjątkowo szeroki "kanał do bindowania" pozwala bindować bardzo grube dokumenty lub serię kilku mniejszych dokumentów
- Możliwość ustawienia odpowiedniej temperatury dla zapewnienia perfekcyjnych rezultatów bindowania
- Funkcja automatycznego wyłączania - zapewnia dodatkowe bezpieczeństwo
- Możliwość ustawienia czasu bindowania
- Czas trwania jednego cyklu bindowania: 40 - 120 sekund
